...
return [(function (){var pred__22633 = cljs.core.instance_QMARK_;
var expr__22634 = reactive_val;
if(cljs.core.truth_((pred__22633.cljs$core$IFn$_invoke$arity$2 ? pred__22633.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__22634) : pred__22633.call(null,reagent.ratom.RAtom,expr__22634)))){
return "ra";
} else {
if(cljs.core.truth_((pred__22633.cljs$core$IFn$_invoke$arity$2 ? pred__22633.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__22634) : pred__22633.call(null,reagent.ratom.RCursor,expr__22634)))){
return "rc";
} else {
if(cljs.core.truth_((pred__22633.cljs$core$IFn$_invoke$arity$2 ? pred__22633.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__22634) : pred__22633.call(null,reagent.ratom.Reaction,expr__22634)))){
return "rx";
} else {
if(cljs.core.truth_((pred__22633.cljs$core$IFn$_invoke$arity$2 ? pred__22633.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__22634) : pred__22633.call(null,reagent.ratom.Track,expr__22634)))){
return "tr";
} else {
return "other";
}
