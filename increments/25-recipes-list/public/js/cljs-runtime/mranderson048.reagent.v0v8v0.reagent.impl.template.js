...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__20839__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__20840__i < G__20840__a.length) {G__20840__a[G__20840__i] = arguments[G__20840__i + 0]; ++G__20840__i;}
  args = new cljs.core.IndexedSeq(G__20840__a,0,null);
} 
return G__20839__delegate.call(this,args);};
G__20839.cljs$lang$maxFixedArity = 0;
G__20839.cljs$lang$applyTo = (function (arglist__20841){
var args = cljs.core.seq(arglist__20841);
return G__20839__delegate(args);
});
...
var jsprops = ({"argv": v});
var temp__5461__auto___20852 = mranderson048.reagent.v0v8v0.reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___20852 == null)){
} else {
var key_20853 = temp__5461__auto___20852;
(jsprops["key"] = key_20853);
}
...
var temp__5461__auto___20858 = mranderson048.reagent.v0v8v0.reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___20858 == null)){
} else {
var key_20860 = temp__5461__auto___20858;
mranderson048.reagent.v0v8v0.reagent.impl.template.oset(jsprops,"key",key_20860);
}
...
var G__20894 = (i__4731__auto___20890 + (1));
i__4731__auto___20890 = G__20894;
continue;
} else {
}
break;
...
break;
default:
var G__20903 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__20903;
continue;
