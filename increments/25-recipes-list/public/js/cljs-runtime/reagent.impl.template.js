...
var G__22398 = o;
(G__22398[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__22402 = o;
(G__22402[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__22479__i < G__22479__a.length) {G__22479__a[G__22479__i] = arguments[G__22479__i + 0]; ++G__22479__i;}
  args = new cljs.core.IndexedSeq(G__22479__a,0,null);
} 
return G__22478__delegate.call(this,args);};
G__22478.cljs$lang$maxFixedArity = 0;
G__22478.cljs$lang$applyTo = (function (arglist__22483){
var args = cljs.core.seq(arglist__22483);
...
var G__22406 = props;
var G__22406__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22406,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22406);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22406__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__22407){
var map__22408 = p__22407;
var map__22408__$1 = (((((!((map__22408 == null))))?(((((map__22408.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22408.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22408):map__22408);
var props = map__22408__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22408__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__22408,map__22408__$1,props,class$){
return (function (c){
...
});})(map__22408,map__22408__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__22418){
var map__22419 = p__22418;
var map__22419__$1 = (((((!((map__22419 == null))))?(((((map__22419.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22419.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22419):map__22419);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22419__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__22419,map__22419__$1,on_write){
return (function (){
...
});})(node_value,map__22419,map__22419__$1,on_write))
);
} else {
...
var G__22429 = jsprops;
(G__22429["defaultValue"] = value);

(G__22429["onChange"] = ((function (G__22429,v,value,on_change){
return (function (p1__22428_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__22428_SHARP_);
});})(G__22429,v,value,on_change))
);
...
var vec__22437 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22437,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22437,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22437,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___22508 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___22508 == null)){
} else {
var key_22509 = temp__5461__auto___22508;
(jsprops["key"] = key_22509);
}
...
var temp__5461__auto___22515 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___22515 == null)){
} else {
var key_22516 = temp__5461__auto___22515;
reagent.impl.template.oset(jsprops,"key",key_22516);
}
...
var G__22450 = reagent.impl.template.__GT_NativeWrapper();
(G__22450["name"] = c);
...
var G__22455 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__22455) : reagent.impl.template.as_element.call(null,G__22455));
} else {
...
var len__4730__auto___22547 = arguments.length;
var i__4731__auto___22548 = (0);
while(true){
if((i__4731__auto___22548 < len__4730__auto___22547)){
args__4736__auto__.push((arguments[i__4731__auto___22548]));

var G__22550 = (i__4731__auto___22548 + (1));
i__4731__auto___22548 = G__22550;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq22459){
var G__22460 = cljs.core.first(seq22459);
var seq22459__$1 = cljs.core.next(seq22459);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22460,seq22459__$1);
});
...
break;
default:
var G__22562 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__22562;
continue;
...
var n__4607__auto___22571 = a.length;
var i_22572 = (0);
while(true){
if((i_22572 < n__4607__auto___22571)){
(a[i_22572] = reagent.impl.template.as_element((a[i_22572])));

var G__22573 = (i_22572 + (1));
i_22572 = G__22573;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___22574 = a.length;
var i_22575 = (0);
while(true){
if((i_22575 < n__4607__auto___22574)){
var val_22576 = (a[i_22575]);
if(((cljs.core.vector_QMARK_(val_22576)) && ((reagent.impl.template.key_from_vec(val_22576) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_22575] = reagent.impl.template.as_element(val_22576));

var G__22577 = (i_22575 + (1));
i_22575 = G__22577;
continue;
} else {
}
...
var ctx = ({});
var vec__22464 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22464,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22464,(1),null);
...
var G__22468 = (cljs.core.count(argv) - first_child);
switch (G__22468) {
case (0):
...
case (1):
var G__22469 = comp;
var G__22470 = jsprops;
var G__22471 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__22469,G__22470,G__22471);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__22468){
