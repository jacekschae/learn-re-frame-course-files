...
app.router.history = (function (){var dispatch = (function (p1__25804_SHARP_){
var G__25806 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"route-changed","route-changed",455870141),p1__25804_SHARP_], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__25806) : re_frame.core.dispatch.call(null,G__25806));
});
var match = ((function (dispatch){
return (function (p1__25805_SHARP_){
return bidi.bidi.match_route(app.router.routes,p1__25805_SHARP_);
});})(dispatch))
;
...
app.router.path_for = (function app$router$path_for(route){
return bidi.bidi.path_for(app.router.routes,route);
});
