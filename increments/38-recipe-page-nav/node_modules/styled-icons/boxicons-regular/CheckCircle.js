...
var StyledIcon = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement("svg", __assign({}, iconProps, svgProps, { ref: ref }),
        props.title && React.createElement("title", { key: "CheckCircle-title" }, props.title),
        React.createElement("path", { fill: "none", d: "M12 4c-4.411 0-8 3.589-8 8s3.589 8 8 8 8-3.589 8-8-3.589-8-8-8zm-1.293 11.707a.997.997 0 0 1-1.413.001l-3.006-3L7.7 11.292l2.299 2.295 5.794-5.794 1.414 1.414-6.5 6.5z", key: "k0" }),
        ",",
        ...
        ",",
        React.createElement("path", { d: "M9.999 13.587L7.7 11.292l-1.412 1.416 3.006 3a.998.998 0 0 0 1.413-.001l6.5-6.5-1.414-1.414-5.794 5.794z", key: "k2" })));
});
export var CheckCircle = styled(StyledIcon)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  display: inline-block;\n  vertical-align: middle;\n  overflow: hidden;\n"], ["\n  display: inline-block;\n  vertical-align: middle;\n  overflow: hidden;\n"])));
