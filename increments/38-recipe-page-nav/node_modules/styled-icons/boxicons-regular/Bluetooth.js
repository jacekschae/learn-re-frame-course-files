...
var StyledIcon = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement("svg", __assign({}, iconProps, svgProps, { ref: ref }),
        props.title && React.createElement("title", { key: "Bluetooth-title" }, props.title),
        React.createElement("path", { fill: "none", d: "M12 13.817V19l3.362-2.521zM12 5v5.183l3.362-2.662z", key: "k0" }),
        ",",
        React.createElement("path", { d: "M5.621 17.784L10 14.317V21a1.001 1.001 0 0 0 1.6.8l6-4.5a1 1 0 0 0 .021-1.584L12.927 12l4.694-3.716A1.001 1.001 0 0 0 17.6 6.7l-6-4.5A1.001 1.001 0 0 0 10 3v6.683L5.621 6.216 4.379 7.784 9.705 12l-5.326 4.216 1.242 1.568zM12 5l3.362 2.521L12 10.183V5zm0 8.817l3.362 2.662L12 19v-5.183z", key: "k1" })));
});
export var Bluetooth = styled(StyledIcon)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  display: inline-block;\n  vertical-align: middle;\n  overflow: hidden;\n"], ["\n  display: inline-block;\n  vertical-align: middle;\n  overflow: hidden;\n"])));
