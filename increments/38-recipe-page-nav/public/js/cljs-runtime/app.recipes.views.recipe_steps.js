...
var G__26116_26214 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"open-modal","open-modal",947793572),modal_name], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__26116_26214) : re_frame.core.dispatch.call(null,G__26116_26214));
...
var desc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26120__$1,new cljs.core.Keyword(null,"desc","desc",2093485764));
var G__26124_26215 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"upsert-step","upsert-step",-776873689),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4131__auto__ = id;
...
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__26124_26215) : re_frame.core.dispatch.call(null,G__26124_26215));
...
return (function (){
var steps = cljs.core.deref((function (){var G__26127 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"steps","steps",-128433302)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__26127) : re_frame.core.subscribe.call(null,G__26127));
})());
var author_QMARK_ = cljs.core.deref((function (){var G__26128 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"author?","author?",-1083349935)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__26128) : re_frame.core.subscribe.call(null,G__26128));
})());
...
return (function app$recipes$views$recipe_steps$recipe_steps_$_iter__26129(s__26130){
...
var c__4521__auto__ = cljs.core.chunk_first(s__26130__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__26132 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__26131 = (0);
while(true){
if((i__26131 < size__4522__auto__)){
var map__26137 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__26131);
...
var step = map__26137__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26137__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var desc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26137__$1,new cljs.core.Keyword(null,"desc","desc",2093485764));
cljs.core.chunk_append(b__26132,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Box,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"py","py",1397985916),(10)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Row,(cljs.core.truth_(author_QMARK_)?new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__26131,map__26137,map__26137__$1,step,id,desc,c__4521__auto__,size__4522__auto__,b__26132,s__26130__$2,temp__5457__auto__,steps,author_QMARK_,initial_values,values,open_modal,save){
return (function (){
...
});})(i__26131,map__26137,map__26137__$1,step,id,desc,c__4521__auto__,size__4522__auto__,b__26132,s__26130__$2,temp__5457__auto__,steps,author_QMARK_,initial_values,values,open_modal,save))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26132),app$recipes$views$recipe_steps$recipe_steps_$_iter__26129(cljs.core.chunk_rest(s__26130__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26132),null);
}
} else {
var map__26188 = cljs.core.first(s__26130__$2);
...
var step = map__26188__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26188__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var desc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26188__$1,new cljs.core.Keyword(null,"desc","desc",2093485764));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Box,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"py","py",1397985916),(10)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Row,(cljs.core.truth_(author_QMARK_)?new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__26188,map__26188__$1,step,id,desc,s__26130__$2,temp__5457__auto__,steps,author_QMARK_,initial_values,values,open_modal,save){
return (function (){
return open_modal(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"modal-name","modal-name",-2096322394),new cljs.core.Keyword(null,"step-editor","step-editor",1799616437),new cljs.core.Keyword(null,"step","step",1288888124),step], null));
});})(map__26188,map__26188__$1,step,id,desc,s__26130__$2,temp__5457__auto__,steps,author_QMARK_,initial_values,values,open_modal,save))
,new cljs.core.Keyword(null,"class","class",-2030961996),"editable"], null):null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Col,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"py","py",1397985916),(10)], null),desc], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),app$recipes$views$recipe_steps$recipe_steps_$_iter__26129(cljs.core.rest(s__26130__$2)));
}
} else {
return null;
}
...
var G__26201 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"delete-step","delete-step",587926903),step_id], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__26201) : re_frame.core.dispatch.call(null,G__26201));
} else {
return null;
}
...
return (function (){
var G__26202 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"close-modal","close-modal",-1882189985)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__26202) : re_frame.core.dispatch.call(null,G__26202));
});})(steps,author_QMARK_,initial_values,values,open_modal,save))
