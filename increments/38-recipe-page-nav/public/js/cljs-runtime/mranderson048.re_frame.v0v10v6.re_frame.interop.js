...
return [(function (){var pred__20953 = cljs.core.instance_QMARK_;
var expr__20954 = reactive_val;
if(cljs.core.truth_((pred__20953.cljs$core$IFn$_invoke$arity$2 ? pred__20953.cljs$core$IFn$_invoke$arity$2(mranderson048.reagent.v0v8v0.reagent.ratom.RAtom,expr__20954) : pred__20953.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.RAtom,expr__20954)))){
return "ra";
} else {
if(cljs.core.truth_((pred__20953.cljs$core$IFn$_invoke$arity$2 ? pred__20953.cljs$core$IFn$_invoke$arity$2(mranderson048.reagent.v0v8v0.reagent.ratom.RCursor,expr__20954) : pred__20953.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.RCursor,expr__20954)))){
return "rc";
} else {
if(cljs.core.truth_((pred__20953.cljs$core$IFn$_invoke$arity$2 ? pred__20953.cljs$core$IFn$_invoke$arity$2(mranderson048.reagent.v0v8v0.reagent.ratom.Reaction,expr__20954) : pred__20953.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.Reaction,expr__20954)))){
return "rx";
} else {
if(cljs.core.truth_((pred__20953.cljs$core$IFn$_invoke$arity$2 ? pred__20953.cljs$core$IFn$_invoke$arity$2(mranderson048.reagent.v0v8v0.reagent.ratom.Track,expr__20954) : pred__20953.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.Track,expr__20954)))){
return "tr";
} else {
return "other";
}
