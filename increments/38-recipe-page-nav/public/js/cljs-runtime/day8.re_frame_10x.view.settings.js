...
day8.re_frame_10x.view.settings.settings_box_81 = mranderson048.garden.v1v3v3.garden.compiler.render_css((function (){var G__21939 = day8.re_frame_10x.common_styles.gs_81;
var G__21940 = (mranderson048.garden.v1v3v3.garden.units.px_STAR_.cljs$core$IFn$_invoke$arity$2 ? mranderson048.garden.v1v3v3.garden.units.px_STAR_.cljs$core$IFn$_invoke$arity$2((2),day8.re_frame_10x.view.settings.settings_box_vertical_padding) : mranderson048.garden.v1v3v3.garden.units.px_STAR_.call(null,(2),day8.re_frame_10x.view.settings.settings_box_vertical_padding));
return (mranderson048.garden.v1v3v3.garden.units.px_.cljs$core$IFn$_invoke$arity$2 ? mranderson048.garden.v1v3v3.garden.units.px_.cljs$core$IFn$_invoke$arity$2(G__21939,G__21940) : mranderson048.garden.v1v3v3.garden.units.px_.call(null,G__21939,G__21940));
})());
day8.re_frame_10x.view.settings.settings_box_131 = mranderson048.garden.v1v3v3.garden.compiler.render_css((function (){var G__21941 = day8.re_frame_10x.common_styles.gs_131;
var G__21942 = (mranderson048.garden.v1v3v3.garden.units.px_STAR_.cljs$core$IFn$_invoke$arity$2 ? mranderson048.garden.v1v3v3.garden.units.px_STAR_.cljs$core$IFn$_invoke$arity$2((2),day8.re_frame_10x.view.settings.settings_box_vertical_padding) : mranderson048.garden.v1v3v3.garden.units.px_STAR_.call(null,(2),day8.re_frame_10x.view.settings.settings_box_vertical_padding));
return (mranderson048.garden.v1v3v3.garden.units.px_.cljs$core$IFn$_invoke$arity$2 ? mranderson048.garden.v1v3v3.garden.units.px_.cljs$core$IFn$_invoke$arity$2(G__21941,G__21942) : mranderson048.garden.v1v3v3.garden.units.px_.call(null,G__21941,G__21942));
})());
...
var G__22024 = (i__4731__auto___22021 + (1));
i__4731__auto___22021 = G__22024;
continue;
} else {
}
break;
...
day8.re_frame_10x.view.settings.closeable_text_box.cljs$core$IFn$_invoke$arity$variadic = (function (p__21944){
...
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21945__$1,new cljs.core.Keyword(null,"model","model",331153215));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21945__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var on_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21945__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21945__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
var G__21967 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","set-number-of-retained-epochs","settings/set-number-of-retained-epochs",-1910736736),p1__21951_SHARP_], null);
...
var G__21970 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","app-db-follows-events?","settings/app-db-follows-events?",-115495889),p1__21952_SHARP_], null);
...
var G__21971 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","add-ignored-event","settings/add-ignored-event",-1185281607)], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__21971) : mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.call(null,G__21971));
...
var b__21975 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__21974 = (0);
while(true){
if((i__21974 < size__4522__auto__)){
var item = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__21974);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
cljs.core.chunk_append(b__21975,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"event-str","event-str",381347778).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"212px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (i__21974,id,item,c__4521__auto__,size__4522__auto__,b__21975,s__21973__$2,temp__5457__auto__){
return (function (){
var G__21982 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","remove-ignored-event","settings/remove-ignored-event",-391073521),id], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__21982) : mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.call(null,G__21982));
});})(i__21974,id,item,c__4521__auto__,size__4522__auto__,b__21975,s__21973__$2,temp__5457__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__21974,id,item,c__4521__auto__,size__4522__auto__,b__21975,s__21973__$2,temp__5457__auto__){
return (function (p1__21955_SHARP_){
var G__21983 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-ignored-event","settings/update-ignored-event",-407164743),id,p1__21955_SHARP_], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__21983) : mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.call(null,G__21983));
});})(i__21974,id,item,c__4521__auto__,size__4522__auto__,b__21975,s__21973__$2,temp__5457__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__22039 = (i__21974 + (1));
i__21974 = G__22039;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21975),day8$re_frame_10x$view$settings$render_$_iter__21972(cljs.core.chunk_rest(s__21973__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21975),null);
}
} else {
...
return (function (){
var G__21984 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","remove-ignored-event","settings/remove-ignored-event",-391073521),id], null);
...
return (function (p1__21955_SHARP_){
var G__21988 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-ignored-event","settings/update-ignored-event",-407164743),id,p1__21955_SHARP_], null);
...
return iter__4523__auto__(cljs.core.deref((function (){var G__21990 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","ignored-events","settings/ignored-events",1377799632)], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__21990) : mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.call(null,G__21990));
})()));
...
var G__21991 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","add-filtered-view-trace","settings/add-filtered-view-trace",1856187997)], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__21991) : mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.call(null,G__21991));
})], null)], null)], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"width","width",-384071477),day8.re_frame_10x.view.settings.comp_section_width,new cljs.core.Keyword(null,"gap","gap",80255254),day8.re_frame_10x.view.settings.vertical_gap,new cljs.core.Keyword(null,"children","children",-940561982),(function (){var iter__4523__auto__ = (function day8$re_frame_10x$view$settings$render_$_iter__21992(s__21993){
return (new cljs.core.LazySeq(null,(function (){
var s__21993__$1 = s__21993;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__21993__$1);
if(temp__5457__auto__){
var s__21993__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__21993__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__21993__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__21995 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__21994 = (0);
while(true){
if((i__21994 < size__4522__auto__)){
var item = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__21994);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
cljs.core.chunk_append(b__21995,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"343px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (i__21994,id,item,c__4521__auto__,size__4522__auto__,b__21995,s__21993__$2,temp__5457__auto__){
return (function (){
var G__21996 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","remove-filtered-view-trace","settings/remove-filtered-view-trace",970685301),id], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__21996) : mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.call(null,G__21996));
});})(i__21994,id,item,c__4521__auto__,size__4522__auto__,b__21995,s__21993__$2,temp__5457__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__21994,id,item,c__4521__auto__,size__4522__auto__,b__21995,s__21993__$2,temp__5457__auto__){
return (function (p1__21957_SHARP_){
var G__21997 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-filtered-view-trace","settings/update-filtered-view-trace",-530575796),id,p1__21957_SHARP_], null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21995),day8$re_frame_10x$view$settings$render_$_iter__21992(cljs.core.chunk_rest(s__21993__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21995),null);
}
} else {
var item = cljs.core.first(s__21993__$2);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"343px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (id,item,s__21993__$2,temp__5457__auto__){
return (function (){
var G__21998 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","remove-filtered-view-trace","settings/remove-filtered-view-trace",970685301),id], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__21998) : mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.call(null,G__21998));
});})(id,item,s__21993__$2,temp__5457__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (id,item,s__21993__$2,temp__5457__auto__){
return (function (p1__21957_SHARP_){
var G__21999 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-filtered-view-trace","settings/update-filtered-view-trace",-530575796),id,p1__21957_SHARP_], null);
...
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$settings$render_$_iter__21992(cljs.core.rest(s__21993__$2)));
}
} else {
return null;
}
...
return iter__4523__auto__(cljs.core.deref((function (){var G__22000 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","filtered-view-trace","settings/filtered-view-trace",818098350)], null);
...
})()], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),"Sometimes you want to focus on your own views, and the trace associated with library views is just noise."], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),"Nominate one or more namespaces."], null)], null),day8.re_frame_10x.view.settings.settings_box_131], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.line], null),(function (){var low_level_trace = cljs.core.deref((function (){var G__22001 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","low-level-trace","settings/low-level-trace",191054289)], null);
...
var G__22003 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","low-level-trace","settings/low-level-trace",191054289),new cljs.core.Keyword(null,"reagent","reagent",2131627322),p1__21958_SHARP_], null);
...
var G__22006 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","low-level-trace","settings/low-level-trace",191054289),new cljs.core.Keyword(null,"re-frame","re-frame",-1039473033),p1__21963_SHARP_], null);
...
var G__22011 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","factory-reset","settings/factory-reset",1863855805)], null);
