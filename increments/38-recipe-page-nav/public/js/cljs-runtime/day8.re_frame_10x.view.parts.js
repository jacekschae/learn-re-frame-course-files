...
var iter__4523__auto__ = (function day8$re_frame_10x$view$parts$render_registered_$_iter__23447(s__23448){
return (new cljs.core.LazySeq(null,(function (){
var s__23448__$1 = s__23448;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__23448__$1);
if(temp__5457__auto__){
var s__23448__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__23448__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__23448__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__23450 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__23449 = (0);
while(true){
if((i__23449 < size__4522__auto__)){
var vec__23463 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__23449);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23450),day8$re_frame_10x$view$parts$render_registered_$_iter__23447(cljs.core.chunk_rest(s__23448__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23450),null);
}
} else {
var vec__23466 = cljs.core.first(s__23448__$2);
...
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"border","border",1444987323),"1px black solid",new cljs.core.Keyword(null,"padding","padding",1660304693),"10px",new cljs.core.Keyword(null,"margin-right","margin-right",809689658),"10px"], null)], null),cljs.core.prn_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([k], 0))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(kind),"|",cljs.core.str.cljs$core$IFn$_invoke$arity$1(k)].join('')], null)),day8$re_frame_10x$view$parts$render_registered_$_iter__23447(cljs.core.rest(s__23448__$2)));
}
} else {
return null;
}
...
var vec__23496 = cljs.core.first(s__23474__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23496,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23496,(1),null);
