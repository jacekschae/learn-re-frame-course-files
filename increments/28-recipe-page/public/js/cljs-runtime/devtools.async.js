...
var o__21913__auto___23896 = (function (){var o__21913__auto__ = (function (){var o__21913__auto__ = Promise;
return (o__21913__auto__["resolve"]).call(o__21913__auto__);
})();
return (o__21913__auto__["then"]).call(o__21913__auto__,callback);
})();
(o__21913__auto___23896["catch"]).call(o__21913__auto___23896,devtools.async.rethrow_outside_promise);
...
var G__23874_23910 = Error;
var target__21927__auto___23911 = G__23874_23910;
if(cljs.core.truth_(target__21927__auto___23911)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__23874_23910)].join(''),"\n","target__21927__auto__"].join('')));
}

(target__21927__auto___23911["stackTraceLimit"] = Infinity);
