...
app.auth.events.set_user_ls_BANG_ = (function app$auth$events$set_user_ls_BANG_(p__25835){
...
var auth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25836__$1,new cljs.core.Keyword(null,"auth","auth",1389754926));
...
var G__25839_25907 = new cljs.core.Keyword(null,"local-store-user","local-store-user",1737970699);
var G__25840_25908 = ((function (G__25839_25907){
...
;
(re_frame.core.reg_cofx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_cofx.cljs$core$IFn$_invoke$arity$2(G__25839_25907,G__25840_25908) : re_frame.core.reg_cofx.call(null,G__25839_25907,G__25840_25908));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"sign-up","sign-up",-1190725688),app.auth.events.set_user_interceptors,(function (p__25843,p__25844){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25845__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__25846 = p__25844;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25846,(0),null);
var map__25849 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25846,(1),null);
...
var first_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25849__$1,new cljs.core.Keyword(null,"first-name","first-name",-1559982131));
var last_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25849__$1,new cljs.core.Keyword(null,"last-name","last-name",-1695738974));
var email = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25849__$1,new cljs.core.Keyword(null,"email","email",1415816706));
var password = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25849__$1,new cljs.core.Keyword(null,"password","password",417022471));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"log-in","log-in",526627385),app.auth.events.set_user_interceptors,(function (p__25861,p__25862){
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"log-out","log-out",-2094664701),app.auth.events.remove_user_interceptors,(function (p__25876,_){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25877__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"update-profile","update-profile",1458083625),(function (db,p__25883){
var vec__25887 = p__25883;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25887,(0),null);
var profile = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25887,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"delete-account","delete-account",725157341),app.auth.events.remove_user_interceptors,(function (p__25893,_){
var map__25895 = p__25893;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25895__$1,new cljs.core.Keyword(null,"db","db",993250759));
var uid = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"auth","auth",1389754926),new cljs.core.Keyword(null,"uid","uid",-1447769400)], null));
