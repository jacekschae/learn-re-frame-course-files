...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__31048_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__31048_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__31048_SHARP_);
} else {
...
var vec__31058 = p__31054;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31058,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31058,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__31073,s,color,element,idx){
var map__31077 = p__31073;
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31077__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31077__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31077__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__31090 = (function (){var or__4131__auto__ = color;
...
var fexpr__31089 = (function (){var G__31091 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__31091) : style_map.call(null,G__31091));
})();
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__31097){
var vec__31098 = p__31097;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31098,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31098,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31098,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__31102){
var vec__31103 = p__31102;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31103,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31103,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31103,(2),null);
...
var vec__31126 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31126,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31126,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31126,(2),null);
...
var G__31395 = cljs.core.next(remaining_cvec);
var G__31396 = new_idx;
var G__31397 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__31395;
idx = G__31396;
out = G__31397;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__31152,cursor_vec){
var vec__31154 = p__31152;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31154,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31154,(1),null);
var focus_vec = vec__31154;
...
var vec__31157 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31157,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31157,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__31165){
var vec__31166 = p__31165;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31166,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31166,(1),null);
if((color == null)){
return s;
} else {
...
zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__31185,existing_count){
var vec__31186 = p__31185;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31186,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31186,(1),null);
...
return cljs.core.filterv(((function (s__$1,len,cursor__$1,vec__31186,s,cursor){
return (function (p1__31175_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__31175_SHARP_))));
});})(s__$1,len,cursor__$1,vec__31186,s,cursor))
...
var vec__31225 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31225,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31225,(1),null);
var cvec_element = vec__31225;
if((cvec_element == null)){
var G__31456 = cljs.core.next(cvec_nl);
var G__31457 = (idx + (1));
var G__31458 = start;
var G__31459 = out;
cvec_nl = G__31456;
...
var G__31460 = cljs.core.next(cvec_nl);
var G__31461 = (idx + (1));
var G__31462 = idx;
var G__31463 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__31460;
idx = G__31461;
start = G__31462;
out = G__31463;
...
var G__31465 = cljs.core.next(cvec_nl);
var G__31466 = (idx + (1));
var G__31467 = (idx + (1));
var G__31468 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__31465;
idx = G__31466;
start = G__31467;
out = G__31468;
...
var G__31470 = cljs.core.next(cvec_nl);
var G__31471 = (idx + (1));
var G__31472 = idx;
var G__31473 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__31470;
idx = G__31471;
start = G__31472;
out = G__31473;
...
var G__31477 = cljs.core.next(cvec_nl);
var G__31478 = (idx + (1));
var G__31479 = start;
var G__31480 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__31477;
idx = G__31478;
start = G__31479;
out = G__31480;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__31283_SHARP_,p2__31272_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__31272_SHARP_)){
return cljs.core.reduced(p1__31283_SHARP_);
} else {
return (p1__31283_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__31353,p__31354){
var vec__31355 = p__31353;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31355,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31355,(1),null);
var vec__31358 = p__31354;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31358,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31358,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__31365,cvec,focus_vec){
...
var options = map__31366__$1;
var map__31367 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31366__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31367__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31367__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31367__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__31366,map__31366__$1,options,map__31367,map__31367__$1,focus,lines,paths){
return (function (p1__31363_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__31363_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
});})(lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__31366,map__31366__$1,options,map__31367,map__31367__$1,focus,lines,paths))
,path_vecs);
