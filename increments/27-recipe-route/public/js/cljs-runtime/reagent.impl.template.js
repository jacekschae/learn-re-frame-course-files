...
var G__22436 = o;
(G__22436[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__22441 = o;
(G__22441[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__22443 = props;
var G__22443__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22443,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22443);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22443__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__22444){
...
var props = map__22445__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22445__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__22445,map__22445__$1,props,class$){
return (function (c){
...
});})(map__22445,map__22445__$1,props,class$))
,class$)));
} else {
return props;
}
...
var G__22453 = jsprops;
(G__22453["defaultValue"] = value);

(G__22453["onChange"] = ((function (G__22453,v,value,on_change){
return (function (p1__22452_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__22452_SHARP_);
});})(G__22453,v,value,on_change))
);
...
var vec__22455 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22455,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22455,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22455,(2),null);
...
var G__22459 = reagent.impl.template.__GT_NativeWrapper();
(G__22459["name"] = c);
...
var G__22461 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__22461) : reagent.impl.template.as_element.call(null,G__22461));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq22470){
var G__22471 = cljs.core.first(seq22470);
var seq22470__$1 = cljs.core.next(seq22470);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22471,seq22470__$1);
});
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___22568 = a.length;
var i_22569 = (0);
while(true){
if((i_22569 < n__4607__auto___22568)){
var val_22570 = (a[i_22569]);
if(((cljs.core.vector_QMARK_(val_22570)) && ((reagent.impl.template.key_from_vec(val_22570) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_22569] = reagent.impl.template.as_element(val_22570));

var G__22571 = (i_22569 + (1));
i_22569 = G__22571;
continue;
} else {
}
...
var ctx = ({});
var vec__22493 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
...
var G__22500 = (cljs.core.count(argv) - first_child);
switch (G__22500) {
case (0):
...
break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__22500){
