...
day8.re_frame_10x.view.settings.settings_box_131 = mranderson048.garden.v1v3v3.garden.compiler.render_css((function (){var G__21937 = day8.re_frame_10x.common_styles.gs_131;
var G__21938 = (mranderson048.garden.v1v3v3.garden.units.px_STAR_.cljs$core$IFn$_invoke$arity$2 ? mranderson048.garden.v1v3v3.garden.units.px_STAR_.cljs$core$IFn$_invoke$arity$2((2),day8.re_frame_10x.view.settings.settings_box_vertical_padding) : mranderson048.garden.v1v3v3.garden.units.px_STAR_.call(null,(2),day8.re_frame_10x.view.settings.settings_box_vertical_padding));
return (mranderson048.garden.v1v3v3.garden.units.px_.cljs$core$IFn$_invoke$arity$2 ? mranderson048.garden.v1v3v3.garden.units.px_.cljs$core$IFn$_invoke$arity$2(G__21937,G__21938) : mranderson048.garden.v1v3v3.garden.units.px_.call(null,G__21937,G__21938));
})());
...
var len__4730__auto___22034 = arguments.length;
var i__4731__auto___22035 = (0);
while(true){
if((i__4731__auto___22035 < len__4730__auto___22034)){
args__4736__auto__.push((arguments[i__4731__auto___22035]));

var G__22036 = (i__4731__auto___22035 + (1));
i__4731__auto___22035 = G__22036;
continue;
} else {
}
break;
...
/** @this {Function} */
day8.re_frame_10x.view.settings.closeable_text_box.cljs$lang$applyTo = (function (seq21940){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq21940));
});
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),day8.re_frame_10x.common_styles.gs_12s,new cljs.core.Keyword(null,"margin-right","margin-right",809689658),day8.re_frame_10x.common_styles.gs_19s], null),new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 11, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var num_epochs = cljs.core.deref((function (){var G__21969 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","number-of-matches","epochs/number-of-matches",1018247531)], null);
...
var num_traces = cljs.core.deref((function (){var G__21970 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("traces","number-of-traces","traces/number-of-traces",-1195045241)], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__21970) : mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.call(null,G__21970));
})());
var epochs_to_retain = (function (){var G__21972 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","number-of-retained-epochs","settings/number-of-retained-epochs",347300150)], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__21972) : mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.call(null,G__21972));
})();
...
var G__21973 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","set-number-of-retained-epochs","settings/set-number-of-retained-epochs",-1910736736),p1__21958_SHARP_], null);
...
return (function (){
var G__21974 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","reset","epochs/reset",1592438868)], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__21974) : mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.call(null,G__21974));
});})(num_epochs,num_traces,epochs_to_retain))
...
var G__21979 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","app-db-follows-events?","settings/app-db-follows-events?",-115495889),p1__21959_SHARP_], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__21979) : mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.call(null,G__21979));
...
var G__21981 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","add-ignored-event","settings/add-ignored-event",-1185281607)], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__21981) : mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.call(null,G__21981));
})], null)], null)], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"width","width",-384071477),day8.re_frame_10x.view.settings.comp_section_width,new cljs.core.Keyword(null,"gap","gap",80255254),day8.re_frame_10x.view.settings.vertical_gap,new cljs.core.Keyword(null,"children","children",-940561982),(function (){var iter__4523__auto__ = (function day8$re_frame_10x$view$settings$render_$_iter__21990(s__21991){
return (new cljs.core.LazySeq(null,(function (){
var s__21991__$1 = s__21991;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__21991__$1);
if(temp__5457__auto__){
var s__21991__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__21991__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__21991__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__21997 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__21996 = (0);
while(true){
if((i__21996 < size__4522__auto__)){
var item = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__21996);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
cljs.core.chunk_append(b__21997,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"event-str","event-str",381347778).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"212px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (i__21996,id,item,c__4521__auto__,size__4522__auto__,b__21997,s__21991__$2,temp__5457__auto__){
return (function (){
var G__22003 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","remove-ignored-event","settings/remove-ignored-event",-391073521),id], null);
...
});})(i__21996,id,item,c__4521__auto__,size__4522__auto__,b__21997,s__21991__$2,temp__5457__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__21996,id,item,c__4521__auto__,size__4522__auto__,b__21997,s__21991__$2,temp__5457__auto__){
return (function (p1__21960_SHARP_){
var G__22004 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-ignored-event","settings/update-ignored-event",-407164743),id,p1__21960_SHARP_], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__22004) : mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.call(null,G__22004));
});})(i__21996,id,item,c__4521__auto__,size__4522__auto__,b__21997,s__21991__$2,temp__5457__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__22043 = (i__21996 + (1));
i__21996 = G__22043;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21997),day8$re_frame_10x$view$settings$render_$_iter__21990(cljs.core.chunk_rest(s__21991__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21997),null);
}
} else {
var item = cljs.core.first(s__21991__$2);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"event-str","event-str",381347778).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"212px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (id,item,s__21991__$2,temp__5457__auto__){
return (function (){
var G__22006 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","remove-ignored-event","settings/remove-ignored-event",-391073521),id], null);
...
});})(id,item,s__21991__$2,temp__5457__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (id,item,s__21991__$2,temp__5457__auto__){
return (function (p1__21960_SHARP_){
var G__22007 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-ignored-event","settings/update-ignored-event",-407164743),id,p1__21960_SHARP_], null);
...
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$settings$render_$_iter__21990(cljs.core.rest(s__21991__$2)));
}
} else {
return null;
}
...
return iter__4523__auto__(cljs.core.deref((function (){var G__22008 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","ignored-events","settings/ignored-events",1377799632)], null);
...
var G__22009 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","add-filtered-view-trace","settings/add-filtered-view-trace",1856187997)], null);
...
})], null)], null)], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"width","width",-384071477),day8.re_frame_10x.view.settings.comp_section_width,new cljs.core.Keyword(null,"gap","gap",80255254),day8.re_frame_10x.view.settings.vertical_gap,new cljs.core.Keyword(null,"children","children",-940561982),(function (){var iter__4523__auto__ = (function day8$re_frame_10x$view$settings$render_$_iter__22010(s__22011){
return (new cljs.core.LazySeq(null,(function (){
var s__22011__$1 = s__22011;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__22011__$1);
if(temp__5457__auto__){
var s__22011__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22011__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__22011__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__22013 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__22012 = (0);
while(true){
if((i__22012 < size__4522__auto__)){
var item = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__22012);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
cljs.core.chunk_append(b__22013,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"343px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (i__22012,id,item,c__4521__auto__,size__4522__auto__,b__22013,s__22011__$2,temp__5457__auto__){
return (function (){
var G__22017 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","remove-filtered-view-trace","settings/remove-filtered-view-trace",970685301),id], null);
...
});})(i__22012,id,item,c__4521__auto__,size__4522__auto__,b__22013,s__22011__$2,temp__5457__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__22012,id,item,c__4521__auto__,size__4522__auto__,b__22013,s__22011__$2,temp__5457__auto__){
return (function (p1__21961_SHARP_){
var G__22018 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-filtered-view-trace","settings/update-filtered-view-trace",-530575796),id,p1__21961_SHARP_], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__22018) : mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.call(null,G__22018));
});})(i__22012,id,item,c__4521__auto__,size__4522__auto__,b__22013,s__22011__$2,temp__5457__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__22056 = (i__22012 + (1));
i__22012 = G__22056;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22013),day8$re_frame_10x$view$settings$render_$_iter__22010(cljs.core.chunk_rest(s__22011__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22013),null);
}
} else {
var item = cljs.core.first(s__22011__$2);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"343px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (id,item,s__22011__$2,temp__5457__auto__){
return (function (){
var G__22019 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","remove-filtered-view-trace","settings/remove-filtered-view-trace",970685301),id], null);
...
});})(id,item,s__22011__$2,temp__5457__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (id,item,s__22011__$2,temp__5457__auto__){
return (function (p1__21961_SHARP_){
var G__22020 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-filtered-view-trace","settings/update-filtered-view-trace",-530575796),id,p1__21961_SHARP_], null);
...
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$settings$render_$_iter__22010(cljs.core.rest(s__22011__$2)));
}
} else {
return null;
}
...
return iter__4523__auto__(cljs.core.deref((function (){var G__22021 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","filtered-view-trace","settings/filtered-view-trace",818098350)], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__22021) : mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.call(null,G__22021));
})()));
})()], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),"Sometimes you want to focus on your own views, and the trace associated with library views is just noise."], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),"Nominate one or more namespaces."], null)], null),day8.re_frame_10x.view.settings.settings_box_131], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.line], null),(function (){var low_level_trace = cljs.core.deref((function (){var G__22025 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","low-level-trace","settings/low-level-trace",191054289)], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__22025) : mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.call(null,G__22025));
})());
...
var G__22026 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","low-level-trace","settings/low-level-trace",191054289),new cljs.core.Keyword(null,"reagent","reagent",2131627322),p1__21962_SHARP_], null);
...
var G__22027 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","low-level-trace","settings/low-level-trace",191054289),new cljs.core.Keyword(null,"re-frame","re-frame",-1039473033),p1__21963_SHARP_], null);
...
var G__22028 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","factory-reset","settings/factory-reset",1863855805)], null);
