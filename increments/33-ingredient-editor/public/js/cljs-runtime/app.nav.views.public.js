...
var nav_items = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"recipes","recipes",-325236209),new cljs.core.Keyword(null,"name","name",1843675177),"Recipes",new cljs.core.Keyword(null,"href","href",-793805698),(function (){var G__25973 = new cljs.core.Keyword(null,"recipes","recipes",-325236209);
...
return (function (){
var G__25980 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-active-nav","set-active-nav",-1041462259),new cljs.core.Keyword(null,"sign-up","sign-up",-1190725688)], null);
...
], null),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"log-in","log-in",526627385),new cljs.core.Keyword(null,"name","name",1843675177),"Log in",new cljs.core.Keyword(null,"href","href",-793805698),(function (){var G__25985 = new cljs.core.Keyword(null,"log-in","log-in",526627385);
return (app.router.path_for.cljs$core$IFn$_invoke$arity$1 ? app.router.path_for.cljs$core$IFn$_invoke$arity$1(G__25985) : app.router.path_for.call(null,G__25985));
})(),new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),((function (active_page){
return (function (){
var G__26013 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-active-nav","set-active-nav",-1041462259),new cljs.core.Keyword(null,"log-in","log-in",526627385)], null);
...
return (function app$nav$views$public$public_$_iter__26014(s__26015){
return (new cljs.core.LazySeq(null,((function (active_page,nav_items){
return (function (){
var s__26015__$1 = s__26015;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__26015__$1);
if(temp__5457__auto__){
var s__26015__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26015__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__26015__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__26017 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__26016 = (0);
while(true){
if((i__26016 < size__4522__auto__)){
var map__26020 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__26016);
...
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26020__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var href = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26020__$1,new cljs.core.Keyword(null,"href","href",-793805698));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26020__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
cljs.core.chunk_append(b__26017,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [app.nav.views.nav_item.nav_item,new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"key","key",-1516042587),id,new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"name","name",1843675177),name,new cljs.core.Keyword(null,"href","href",-793805698),href,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),dispatch,new cljs.core.Keyword(null,"active-page","active-page",370357330),active_page], null)], null));

var G__26042 = (i__26016 + (1));
i__26016 = G__26042;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26017),app$nav$views$public$public_$_iter__26014(cljs.core.chunk_rest(s__26015__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26017),null);
}
} else {
var map__26023 = cljs.core.first(s__26015__$2);
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26023__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26023__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var href = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26023__$1,new cljs.core.Keyword(null,"href","href",-793805698));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26023__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [app.nav.views.nav_item.nav_item,new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"key","key",-1516042587),id,new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"name","name",1843675177),name,new cljs.core.Keyword(null,"href","href",-793805698),href,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),dispatch,new cljs.core.Keyword(null,"active-page","active-page",370357330),active_page], null)], null),app$nav$views$public$public_$_iter__26014(cljs.core.rest(s__26015__$2)));
}
} else {
return null;
}
