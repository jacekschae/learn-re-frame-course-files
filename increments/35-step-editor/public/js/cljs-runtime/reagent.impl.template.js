...
while (G__22505__i < G__22505__a.length) {G__22505__a[G__22505__i] = arguments[G__22505__i + 0]; ++G__22505__i;}
  args = new cljs.core.IndexedSeq(G__22505__a,0,null);
} 
return G__22503__delegate.call(this,args);};
G__22503.cljs$lang$maxFixedArity = 0;
G__22503.cljs$lang$applyTo = (function (arglist__22506){
var args = cljs.core.seq(arglist__22506);
...
var G__22415 = jsprops;
(G__22415["defaultValue"] = value);

(G__22415["onChange"] = ((function (G__22415,v,value,on_change){
return (function (p1__22413_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__22413_SHARP_);
});})(G__22415,v,value,on_change))
);
...
var vec__22424 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22424,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22424,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22424,(2),null);
...
var temp__5461__auto___22527 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___22527 == null)){
} else {
var key_22528 = temp__5461__auto___22527;
reagent.impl.template.oset(jsprops,"key",key_22528);
}
...
var G__22435 = reagent.impl.template.__GT_NativeWrapper();
(G__22435["name"] = c);
...
var G__22444 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__22444) : reagent.impl.template.as_element.call(null,G__22444));
} else {
...
var len__4730__auto___22530 = arguments.length;
var i__4731__auto___22531 = (0);
while(true){
if((i__4731__auto___22531 < len__4730__auto___22530)){
args__4736__auto__.push((arguments[i__4731__auto___22531]));

var G__22532 = (i__4731__auto___22531 + (1));
i__4731__auto___22531 = G__22532;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq22452){
...
var i_22559 = (0);
while(true){
if((i_22559 < n__4607__auto___22558)){
(a[i_22559] = reagent.impl.template.as_element((a[i_22559])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___22561 = a.length;
var i_22562 = (0);
while(true){
if((i_22562 < n__4607__auto___22561)){
var val_22563 = (a[i_22562]);
if(((cljs.core.vector_QMARK_(val_22563)) && ((reagent.impl.template.key_from_vec(val_22563) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_22562] = reagent.impl.template.as_element(val_22563));

var G__22565 = (i_22562 + (1));
i_22562 = G__22565;
continue;
} else {
}
...
var ctx = ({});
var vec__22490 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
...
var G__22496 = (cljs.core.count(argv) - first_child);
switch (G__22496) {
case (0):
...
case (1):
var G__22498 = comp;
var G__22499 = jsprops;
var G__22500 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__22498,G__22499,G__22500);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__22496){
