...
var map__26550 = p__26549;
var map__26550__$1 = (((((!((map__26550 == null))))?(((((map__26550.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__26550.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__26550):map__26550);
var modal_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26550__$1,new cljs.core.Keyword(null,"modal-name","modal-name",-2096322394));
var ingredient = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26550__$1,new cljs.core.Keyword(null,"ingredient","ingredient",1011156019));
var G__26552_26569 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"open-modal","open-modal",947793572),modal_name], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__26552_26569) : re_frame.core.dispatch.call(null,G__26552_26569));

return cljs.core.reset_BANG_(values,ingredient);
});})(initial_values,values))
;
var save = ((function (initial_values,values,open_modal){
return (function (p__26553){
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26554__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var amount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26554__$1,new cljs.core.Keyword(null,"amount","amount",364489504));
var measure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26554__$1,new cljs.core.Keyword(null,"measure","measure",-1857519826));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26554__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var G__26556_26570 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"upsert-ingredient","upsert-ingredient",-1543603235),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4131__auto__ = id;
...
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__26556_26570) : re_frame.core.dispatch.call(null,G__26556_26570));
...
return (function (){
var ingredients = cljs.core.deref((function (){var G__26557 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ingredients","ingredients",-1855671917)], null);
...
var author_QMARK_ = cljs.core.deref((function (){var G__26558 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"author?","author?",-1083349935)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__26558) : re_frame.core.subscribe.call(null,G__26558));
})());
...
return (function app$recipes$views$recipe_ingredients$recipe_ingredients_$_iter__26559(s__26560){
return (new cljs.core.LazySeq(null,((function (ingredients,author_QMARK_,initial_values,values,open_modal,save){
return (function (){
var s__26560__$1 = s__26560;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__26560__$1);
if(temp__5457__auto__){
var s__26560__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26560__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__26560__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__26562 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__26561 = (0);
while(true){
if((i__26561 < size__4522__auto__)){
var map__26563 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__26561);
...
var ingredient = map__26563__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26563__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var amount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26563__$1,new cljs.core.Keyword(null,"amount","amount",364489504));
var measure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26563__$1,new cljs.core.Keyword(null,"measure","measure",-1857519826));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26563__$1,new cljs.core.Keyword(null,"name","name",1843675177));
cljs.core.chunk_append(b__26562,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Box,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"py","py",1397985916),(10)], null),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Row,(cljs.core.truth_(author_QMARK_)?new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__26561,map__26563,map__26563__$1,ingredient,id,amount,measure,name,c__4521__auto__,size__4522__auto__,b__26562,s__26560__$2,temp__5457__auto__,ingredients,author_QMARK_,initial_values,values,open_modal,save){
return (function (){
...
});})(i__26561,map__26563,map__26563__$1,ingredient,id,amount,measure,name,c__4521__auto__,size__4522__auto__,b__26562,s__26560__$2,temp__5457__auto__,ingredients,author_QMARK_,initial_values,values,open_modal,save))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26562),app$recipes$views$recipe_ingredients$recipe_ingredients_$_iter__26559(cljs.core.chunk_rest(s__26560__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26562),null);
}
} else {
var map__26565 = cljs.core.first(s__26560__$2);
...
var ingredient = map__26565__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26565__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var amount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26565__$1,new cljs.core.Keyword(null,"amount","amount",364489504));
var measure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26565__$1,new cljs.core.Keyword(null,"measure","measure",-1857519826));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26565__$1,new cljs.core.Keyword(null,"name","name",1843675177));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Box,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"py","py",1397985916),(10)], null),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Row,(cljs.core.truth_(author_QMARK_)?new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__26565,map__26565__$1,ingredient,id,amount,measure,name,s__26560__$2,temp__5457__auto__,ingredients,author_QMARK_,initial_values,values,open_modal,save){
return (function (){
return open_modal(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"modal-name","modal-name",-2096322394),new cljs.core.Keyword(null,"ingredient-editor","ingredient-editor",-375505998),new cljs.core.Keyword(null,"ingredient","ingredient",1011156019),ingredient], null));
});})(map__26565,map__26565__$1,ingredient,id,amount,measure,name,s__26560__$2,temp__5457__auto__,ingredients,author_QMARK_,initial_values,values,open_modal,save))
,new cljs.core.Keyword(null,"class","class",-2030961996),"editable"], null):null),new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Col,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"xs","xs",649443341),(3)], null),amount," ",measure], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Col,name], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),app$recipes$views$recipe_ingredients$recipe_ingredients_$_iter__26559(cljs.core.rest(s__26560__$2)));
}
} else {
return null;
}
...
var G__26567 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"delete-ingredient","delete-ingredient",443101563),ingredient_id], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__26567) : re_frame.core.dispatch.call(null,G__26567));
} else {
return null;
}
...
return (function (){
var G__26568 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"close-modal","close-modal",-1882189985)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__26568) : re_frame.core.dispatch.call(null,G__26568));
});})(ingredients,author_QMARK_,initial_values,values,open_modal,save))
