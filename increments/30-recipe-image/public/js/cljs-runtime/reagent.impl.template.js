...
var G__22402 = o;
(G__22402[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__22403 = o;
(G__22403[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__22476__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__22477__i < G__22477__a.length) {G__22477__a[G__22477__i] = arguments[G__22477__i + 0]; ++G__22477__i;}
  args = new cljs.core.IndexedSeq(G__22477__a,0,null);
} 
...
return reagent.impl.template.input_handle_change(this$,on_change,p1__22427_SHARP_);
...
var jsprops = ({"argv": v});
var temp__5461__auto___22518 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___22518 == null)){
} else {
var key_22519 = temp__5461__auto___22518;
(jsprops["key"] = key_22519);
}
...
var temp__5461__auto___22521 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___22521 == null)){
} else {
var key_22522 = temp__5461__auto___22521;
reagent.impl.template.oset(jsprops,"key",key_22522);
}
...
break;
default:
var G__22557 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__22557;
continue;
...
var n__4607__auto___22559 = a.length;
var i_22560 = (0);
while(true){
if((i_22560 < n__4607__auto___22559)){
(a[i_22560] = reagent.impl.template.as_element((a[i_22560])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___22564 = a.length;
var i_22565 = (0);
while(true){
if((i_22565 < n__4607__auto___22564)){
var val_22566 = (a[i_22565]);
if(((cljs.core.vector_QMARK_(val_22566)) && ((reagent.impl.template.key_from_vec(val_22566) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_22565] = reagent.impl.template.as_element(val_22566));

var G__22570 = (i_22565 + (1));
i_22565 = G__22570;
continue;
} else {
}
