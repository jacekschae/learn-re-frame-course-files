...
day8.re_frame_10x.view.settings.settings_box_81 = mranderson048.garden.v1v3v3.garden.compiler.render_css((function (){var G__21943 = day8.re_frame_10x.common_styles.gs_81;
var G__21944 = (mranderson048.garden.v1v3v3.garden.units.px_STAR_.cljs$core$IFn$_invoke$arity$2 ? mranderson048.garden.v1v3v3.garden.units.px_STAR_.cljs$core$IFn$_invoke$arity$2((2),day8.re_frame_10x.view.settings.settings_box_vertical_padding) : mranderson048.garden.v1v3v3.garden.units.px_STAR_.call(null,(2),day8.re_frame_10x.view.settings.settings_box_vertical_padding));
return (mranderson048.garden.v1v3v3.garden.units.px_.cljs$core$IFn$_invoke$arity$2 ? mranderson048.garden.v1v3v3.garden.units.px_.cljs$core$IFn$_invoke$arity$2(G__21943,G__21944) : mranderson048.garden.v1v3v3.garden.units.px_.call(null,G__21943,G__21944));
})());
day8.re_frame_10x.view.settings.settings_box_131 = mranderson048.garden.v1v3v3.garden.compiler.render_css((function (){var G__21945 = day8.re_frame_10x.common_styles.gs_131;
var G__21946 = (mranderson048.garden.v1v3v3.garden.units.px_STAR_.cljs$core$IFn$_invoke$arity$2 ? mranderson048.garden.v1v3v3.garden.units.px_STAR_.cljs$core$IFn$_invoke$arity$2((2),day8.re_frame_10x.view.settings.settings_box_vertical_padding) : mranderson048.garden.v1v3v3.garden.units.px_STAR_.call(null,(2),day8.re_frame_10x.view.settings.settings_box_vertical_padding));
return (mranderson048.garden.v1v3v3.garden.units.px_.cljs$core$IFn$_invoke$arity$2 ? mranderson048.garden.v1v3v3.garden.units.px_.cljs$core$IFn$_invoke$arity$2(G__21945,G__21946) : mranderson048.garden.v1v3v3.garden.units.px_.call(null,G__21945,G__21946));
})());
...
var len__4730__auto___22038 = arguments.length;
var i__4731__auto___22039 = (0);
while(true){
if((i__4731__auto___22039 < len__4730__auto___22038)){
args__4736__auto__.push((arguments[i__4731__auto___22039]));

var G__22040 = (i__4731__auto___22039 + (1));
i__4731__auto___22039 = G__22040;
continue;
} else {
}
break;
...
/** @this {Function} */
day8.re_frame_10x.view.settings.closeable_text_box.cljs$lang$applyTo = (function (seq21950){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq21950));
});
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),day8.re_frame_10x.common_styles.gs_12s,new cljs.core.Keyword(null,"margin-right","margin-right",809689658),day8.re_frame_10x.common_styles.gs_19s], null),new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 11, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var num_epochs = cljs.core.deref((function (){var G__21971 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","number-of-matches","epochs/number-of-matches",1018247531)], null);
...
var G__21985 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","app-db-follows-events?","settings/app-db-follows-events?",-115495889),p1__21961_SHARP_], null);
...
});})(i__22001,id,item,c__4521__auto__,size__4522__auto__,b__22002,s__22000__$2,temp__5457__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__22001,id,item,c__4521__auto__,size__4522__auto__,b__22002,s__22000__$2,temp__5457__auto__){
return (function (p1__21964_SHARP_){
var G__22005 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-ignored-event","settings/update-ignored-event",-407164743),id,p1__21964_SHARP_], null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22002),day8$re_frame_10x$view$settings$render_$_iter__21999(cljs.core.chunk_rest(s__22000__$2)));
} else {
...
return (function (p1__21964_SHARP_){
var G__22007 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-ignored-event","settings/update-ignored-event",-407164743),id,p1__21964_SHARP_], null);
...
})], null)], null)], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"width","width",-384071477),day8.re_frame_10x.view.settings.comp_section_width,new cljs.core.Keyword(null,"gap","gap",80255254),day8.re_frame_10x.view.settings.vertical_gap,new cljs.core.Keyword(null,"children","children",-940561982),(function (){var iter__4523__auto__ = (function day8$re_frame_10x$view$settings$render_$_iter__22021(s__22022){
return (new cljs.core.LazySeq(null,(function (){
var s__22022__$1 = s__22022;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__22022__$1);
if(temp__5457__auto__){
var s__22022__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22022__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__22022__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__22024 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__22023 = (0);
while(true){
if((i__22023 < size__4522__auto__)){
var item = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__22023);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
cljs.core.chunk_append(b__22024,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"343px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (i__22023,id,item,c__4521__auto__,size__4522__auto__,b__22024,s__22022__$2,temp__5457__auto__){
return (function (){
...
});})(i__22023,id,item,c__4521__auto__,size__4522__auto__,b__22024,s__22022__$2,temp__5457__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__22023,id,item,c__4521__auto__,size__4522__auto__,b__22024,s__22022__$2,temp__5457__auto__){
return (function (p1__21967_SHARP_){
var G__22028 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-filtered-view-trace","settings/update-filtered-view-trace",-530575796),id,p1__21967_SHARP_], null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22024),day8$re_frame_10x$view$settings$render_$_iter__22021(cljs.core.chunk_rest(s__22022__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22024),null);
}
} else {
var item = cljs.core.first(s__22022__$2);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"343px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (id,item,s__22022__$2,temp__5457__auto__){
return (function (){
...
});})(id,item,s__22022__$2,temp__5457__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (id,item,s__22022__$2,temp__5457__auto__){
return (function (p1__21967_SHARP_){
var G__22030 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-filtered-view-trace","settings/update-filtered-view-trace",-530575796),id,p1__21967_SHARP_], null);
...
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$settings$render_$_iter__22021(cljs.core.rest(s__22022__$2)));
}
} else {
return null;
}
...
var G__22033 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","low-level-trace","settings/low-level-trace",191054289),new cljs.core.Keyword(null,"reagent","reagent",2131627322),p1__21968_SHARP_], null);
...
var G__22034 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","low-level-trace","settings/low-level-trace",191054289),new cljs.core.Keyword(null,"re-frame","re-frame",-1039473033),p1__21969_SHARP_], null);
