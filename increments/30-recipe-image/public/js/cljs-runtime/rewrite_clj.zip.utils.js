...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__30782,k,f){
var vec__30784 = p__30782;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30784,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30784,(1),null);
var loc = vec__30784;
...
var G__30835 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__30835;
continue;
}
break;
...
var G__30836 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__30836;
continue;
} else {
return zloc__$1;
...
var G__30837 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__30837;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__30794){
var vec__30795 = p__30794;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30795,(0),null);
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__30806){
var vec__30808 = p__30806;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30808,(0),null);
var map__30811 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30808,(1),null);
...
var path = map__30811__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30811__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__30808;
if(cljs.core.seq(r)){
...
var vec__30816 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30816,(0),null);
var map__30819 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30816,(1),null);
...
var path = map__30819__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30819__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30819__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30819__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30819__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
