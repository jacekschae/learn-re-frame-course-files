...
var iter__4523__auto__ = (function day8$re_frame_10x$view$parts$render_registered_$_iter__23473(s__23474){
...
var vec__23485 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__23475);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23476),day8$re_frame_10x$view$parts$render_registered_$_iter__23473(cljs.core.chunk_rest(s__23474__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23476),null);
}
} else {
var vec__23492 = cljs.core.first(s__23474__$2);
...
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"border","border",1444987323),"1px black solid",new cljs.core.Keyword(null,"padding","padding",1660304693),"10px",new cljs.core.Keyword(null,"margin-right","margin-right",809689658),"10px"], null)], null),cljs.core.prn_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([k], 0))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(kind),"|",cljs.core.str.cljs$core$IFn$_invoke$arity$1(k)].join('')], null)),day8$re_frame_10x$view$parts$render_registered_$_iter__23473(cljs.core.rest(s__23474__$2)));
}
} else {
return null;
}
...
var iter__4523__auto__ = (function day8$re_frame_10x$view$parts$render_subs_$_iter__23496(s__23497){
return (new cljs.core.LazySeq(null,(function (){
var s__23497__$1 = s__23497;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__23497__$1);
if(temp__5457__auto__){
var s__23497__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__23497__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__23497__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__23499 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__23498 = (0);
while(true){
if((i__23498 < size__4522__auto__)){
var vec__23501 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__23498);
...
cljs.core.chunk_append(b__23499,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"border","border",1444987323),"1px black solid",new cljs.core.Keyword(null,"padding","padding",1660304693),"10px",new cljs.core.Keyword(null,"margin-right","margin-right",809689658),"10px"], null)], null),cljs.core.prn_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([k], 0))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(kind),"|",cljs.core.str.cljs$core$IFn$_invoke$arity$1(k)].join('')], null)));

var G__23516 = (i__23498 + (1));
i__23498 = G__23516;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23499),day8$re_frame_10x$view$parts$render_subs_$_iter__23496(cljs.core.chunk_rest(s__23497__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23499),null);
}
} else {
var vec__23505 = cljs.core.first(s__23497__$2);
...
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"border","border",1444987323),"1px black solid",new cljs.core.Keyword(null,"padding","padding",1660304693),"10px",new cljs.core.Keyword(null,"margin-right","margin-right",809689658),"10px"], null)], null),cljs.core.prn_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([k], 0))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(kind),"|",cljs.core.str.cljs$core$IFn$_invoke$arity$1(k)].join('')], null)),day8$re_frame_10x$view$parts$render_subs_$_iter__23496(cljs.core.rest(s__23497__$2)));
}
} else {
return null;
}
