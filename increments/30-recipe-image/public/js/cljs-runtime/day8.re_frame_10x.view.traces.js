...
var G__22472 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("traces","add-filter","traces/add-filter",1646631802),filter_input,filter_type], null);
...
return (function (index,p__22480){
...
var trace = map__22481__$1;
var op_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22481__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22481__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var operation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22481__$1,new cljs.core.Keyword(null,"operation","operation",-1267664310));
var tags = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22481__$1,new cljs.core.Keyword(null,"tags","tags",1771418977));
var duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22481__$1,new cljs.core.Keyword(null,"duration","duration",1444101068));
...
return (new cljs.core.List(null,new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),id,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (show_row_QMARK_,op_name,map__22481,map__22481__$1,trace,op_type,id,operation,tags,duration,debug_QMARK_){
return (function (){
var G__22483 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("traces","toggle-trace","traces/toggle-trace",-995872006),id], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__22483) : mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.call(null,G__22483));
});})(show_row_QMARK_,op_name,map__22481,map__22481__$1,trace,op_type,id,operation,tags,duration,debug_QMARK_))
,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["trace--trace",(function (){var G__22484 = op_type;
...
], null),cljs.core.str.cljs$core$IFn$_invoke$arity$1(op_type)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.trace--op-string","td.trace--op-string",806514025),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.op-string","span.op-string",1365795266),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (show_row_QMARK_,op_name,map__22481,map__22481__$1,trace,op_type,id,operation,tags,duration,debug_QMARK_){
return (function (ev){
...
var vec__22493 = temp__5457__auto__;
var seq__22494 = cljs.core.seq(vec__22493);
var first__22495 = cljs.core.first(seq__22494);
var seq__22494__$1 = cljs.core.next(seq__22494);
var _ = first__22495;
var params = seq__22494__$1;
...
})()], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td.trace--meta.trace--details-icon","td.trace--meta.trace--details-icon",1686328364),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (show_row_QMARK_,op_name,map__22481,map__22481__$1,trace,op_type,id,operation,tags,duration,debug_QMARK_){
return (function (){
...
var trace_detail_expansions = (function (){var G__22505 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("traces","expansions","traces/expansions",1935277191)], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__22505) : mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.call(null,G__22505));
})();
var beginning = (function (){var G__22506 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","beginning-trace-id","epochs/beginning-trace-id",-1340593887)], null);
...
var traces = (function (){var G__22509 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("traces","all-visible-traces","traces/all-visible-traces",-1694272071)], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__22509) : mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.call(null,G__22509));
})();
var current_traces = (function (){var G__22510 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("traces","current-event-visible-traces","traces/current-event-visible-traces",-133224585)], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__22510) : mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.call(null,G__22510));
})();
var show_epoch_traces_QMARK_ = (function (){var G__22511 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("trace-panel","show-epoch-traces?","trace-panel/show-epoch-traces?",-826345951)], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__22511) : mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.call(null,G__22511));
})();
...
return (function (p1__22497_SHARP_){
var G__22512 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("traces","toggle-categories","traces/toggle-categories",-1164634070),p1__22497_SHARP_], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__22512) : mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.call(null,G__22512));
...
var visible_traces = (function (){var G__22513 = traces_to_filter;
var G__22513__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(((function (G__22513,toggle_category_fn,traces_to_filter,filter_input,filter_items,filter_type,input_error,categories,trace_detail_expansions,beginning,end,traces,current_traces,show_epoch_traces_QMARK_){
return (function (trace){
...
});})(G__22513,toggle_category_fn,traces_to_filter,filter_input,filter_items,filter_type,input_error,categories,trace_detail_expansions,beginning,end,traces,current_traces,show_epoch_traces_QMARK_))
,G__22513)
;
var G__22513__$2 = ((cljs.core.seq(cljs.core.deref(categories)))?cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (G__22513,G__22513__$1,toggle_category_fn,traces_to_filter,filter_input,filter_items,filter_type,input_error,categories,trace_detail_expansions,beginning,end,traces,current_traces,show_epoch_traces_QMARK_){
return (function (trace){
...
});})(G__22513,G__22513__$1,toggle_category_fn,traces_to_filter,filter_input,filter_items,filter_type,input_error,categories,trace_detail_expansions,beginning,end,traces,current_traces,show_epoch_traces_QMARK_))
,G__22513__$1):G__22513__$1);
var G__22513__$3 = ((cljs.core.seq(cljs.core.deref(filter_items)))?cljs.core.filter.cljs$core$IFn$_invoke$arity$2(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.every_pred,cljs.core.map.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.view.traces.query__GT_fn,cljs.core.deref(filter_items))),G__22513__$2):G__22513__$2);
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"id","id",-1388402092),G__22513__$3);
...
return (function (){
var G__22525 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("traces","toggle-categories","traces/toggle-categories",-1164634070),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("re-frame.router","fsm-trigger","re-frame.router/fsm-trigger",1379787274),null,new cljs.core.Keyword(null,"componentWillUnmount","componentWillUnmount",1573788814),null], null), null)], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__22525) : mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.call(null,G__22525));
});})(toggle_category_fn,traces_to_filter,visible_traces,save_query,filter_input,filter_items,filter_type,input_error,categories,trace_detail_expansions,beginning,end,traces,current_traces,show_epoch_traces_QMARK_))
...
var G__22526 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("trace-panel","update-show-epoch-traces?","trace-panel/update-show-epoch-traces?",-1935503516),p1__22500_SHARP_], null);
...
return (function (){
var G__22527 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("traces","remove-filter","traces/remove-filter",-1645830686),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item)], null);
...
return (function (){
var G__22528 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("traces","toggle-all-expansions","traces/toggle-all-expansions",1714341025)], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__22528) : mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.call(null,G__22528));
});})(toggle_category_fn,traces_to_filter,visible_traces,save_query,filter_input,filter_items,filter_type,input_error,categories,trace_detail_expansions,beginning,end,traces,current_traces,show_epoch_traces_QMARK_))
...
return (function (){
var G__22531 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","reset","epochs/reset",1592438868)], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__22531) : mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.call(null,G__22531));
});})(toggle_category_fn,traces_to_filter,visible_traces,save_query,filter_input,filter_items,filter_type,input_error,categories,trace_detail_expansions,beginning,end,traces,current_traces,show_epoch_traces_QMARK_))
