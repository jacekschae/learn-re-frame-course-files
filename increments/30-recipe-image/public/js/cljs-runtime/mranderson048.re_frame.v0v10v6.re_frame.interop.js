...
return [(function (){var pred__20950 = cljs.core.instance_QMARK_;
var expr__20951 = reactive_val;
if(cljs.core.truth_((pred__20950.cljs$core$IFn$_invoke$arity$2 ? pred__20950.cljs$core$IFn$_invoke$arity$2(mranderson048.reagent.v0v8v0.reagent.ratom.RAtom,expr__20951) : pred__20950.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.RAtom,expr__20951)))){
return "ra";
} else {
if(cljs.core.truth_((pred__20950.cljs$core$IFn$_invoke$arity$2 ? pred__20950.cljs$core$IFn$_invoke$arity$2(mranderson048.reagent.v0v8v0.reagent.ratom.RCursor,expr__20951) : pred__20950.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.RCursor,expr__20951)))){
return "rc";
} else {
if(cljs.core.truth_((pred__20950.cljs$core$IFn$_invoke$arity$2 ? pred__20950.cljs$core$IFn$_invoke$arity$2(mranderson048.reagent.v0v8v0.reagent.ratom.Reaction,expr__20951) : pred__20950.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.Reaction,expr__20951)))){
return "rx";
} else {
if(cljs.core.truth_((pred__20950.cljs$core$IFn$_invoke$arity$2 ? pred__20950.cljs$core$IFn$_invoke$arity$2(mranderson048.reagent.v0v8v0.reagent.ratom.Track,expr__20951) : pred__20950.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.Track,expr__20951)))){
return "tr";
} else {
return "other";
}
