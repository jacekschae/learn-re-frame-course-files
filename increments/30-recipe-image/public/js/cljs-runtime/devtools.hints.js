...
var G__22056 = cljs.core.PersistentArrayMap.EMPTY;
var G__22057 = native_stack_trace;
var G__22058 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__22059 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__22056,G__22057,G__22058,G__22059) : cljs.stacktrace.parse_stacktrace.call(null,G__22056,G__22057,G__22058,G__22059));
});
...
var map__22061 = top_item;
var map__22061__$1 = (((((!((map__22061 == null))))?(((((map__22061.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22061.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22061):map__22061);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22061__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22061__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22061__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e22060){var _e = e22060;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___22115 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5455__auto___22115)){
var seen_errors_22116 = temp__5455__auto___22115;
if(cljs.core.truth_(seen_errors_22116.has(self))){
} else {
seen_errors_22116.add(self);

var temp__5457__auto___22119 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5457__auto___22119)){
var sense_22126 = temp__5457__auto___22119;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_22126)].join('');
} else {
}
}
} else {
