...
var G__22510 = devtools.prefs.pref(v);
v = G__22510;
continue;
} else {
return v;
...
}catch (e22464){var _e__21929__auto__ = e22464;
return false;
}})();
...
}catch (e22471){var _e__21929__auto__ = e22471;
return false;
}})();
...
}catch (e22473){var _e__21929__auto__ = e22473;
return false;
}}
}
});
...
var vec__22487 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22487,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22487,(1),null);
...
return cljs.core.some((function (p1__22497_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__22497_SHARP_);
}),template);
});
