...
var vec__32751 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__32757 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32757,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32757,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32751,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32751,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__32768){
var vec__32770 = p__32768;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32770,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32770,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32776,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32776,(1),null);
...
var vec__32801 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32801,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32801,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32801,(2),null);
var vec__32804 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32804,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32804,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32804,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__32808){
var vec__32809 = p__32808;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32809,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32809,(1),null);
...
var len__4730__auto___32902 = arguments.length;
var i__4731__auto___32903 = (0);
while(true){
if((i__4731__auto___32903 < len__4730__auto___32902)){
args__4736__auto__.push((arguments[i__4731__auto___32903]));

var G__32904 = (i__4731__auto___32903 + (1));
i__4731__auto___32903 = G__32904;
continue;
} else {
}
break;
...
var vec__32817 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32817,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32817,(1),null);
...
var G__32825 = zprint.core.parse_string_all_options(rest_options);
var G__32826 = zprint.core.czprint_str_internal;
var G__32827 = ":parse-string-all? call";
var G__32828 = (function (){var G__32829 = rewrite_clj.parser.parse_string_all(coll);
...
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__32825,G__32826,G__32827,G__32828) : zprint.core.process_multiple_forms.call(null,G__32825,G__32826,G__32827,G__32828));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__32830 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32830,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32830,(1),null);
...
/** @this {Function} */
zprint.core.czprint_str_internal.cljs$lang$applyTo = (function (seq32812){
var G__32813 = cljs.core.first(seq32812);
var seq32812__$1 = cljs.core.next(seq32812);
var G__32814 = cljs.core.first(seq32812__$1);
var seq32812__$2 = cljs.core.next(seq32812__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32813,G__32814,seq32812__$2);
});
...
var args__4736__auto__ = [];
var len__4730__auto___32921 = arguments.length;
var i__4731__auto___32922 = (0);
while(true){
if((i__4731__auto___32922 < len__4730__auto___32921)){
args__4736__auto__.push((arguments[i__4731__auto___32922]));

var G__32925 = (i__4731__auto___32922 + (1));
i__4731__auto___32922 = G__32925;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.zprint_str.cljs$lang$applyTo = (function (seq32836){
...
var args__4736__auto__ = [];
var len__4730__auto___32932 = arguments.length;
var i__4731__auto___32933 = (0);
while(true){
if((i__4731__auto___32933 < len__4730__auto___32932)){
args__4736__auto__.push((arguments[i__4731__auto___32933]));

var G__32934 = (i__4731__auto___32933 + (1));
i__4731__auto___32933 = G__32934;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.czprint_str.cljs$lang$applyTo = (function (seq32838){
var G__32839 = cljs.core.first(seq32838);
var seq32838__$1 = cljs.core.next(seq32838);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32839,seq32838__$1);
});
...
/** @this {Function} */
zprint.core.zprint.cljs$lang$applyTo = (function (seq32841){
var G__32842 = cljs.core.first(seq32841);
var seq32841__$1 = cljs.core.next(seq32841);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32842,seq32841__$1);
});
...
/** @this {Function} */
zprint.core.czprint.cljs$lang$applyTo = (function (seq32844){
var G__32845 = cljs.core.first(seq32844);
var seq32844__$1 = cljs.core.next(seq32844);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32845,seq32844__$1);
});
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__32853,form){
var vec__32854 = p__32853;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32854,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32854,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32854,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32854,(3),null);
...
var vec__32857 = (cljs.core.truth_((function (){var and__4120__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4120__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32857,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32857,(1),null);
...
var forms = (function (){var G__32868 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__32868) : zprint.zutil.edn_STAR_.call(null,G__32868));
})();
