...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__33420_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__33420_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__33420_SHARP_) <= ending)));
}));
});
...
var G__33446 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("sub","dispose","sub/dispose",365440536),p1__33452_SHARP_);
});})(and__4120__auto__))
...
return cljs.core.assoc_in(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"operation","operation",-1267664310).cljs$core$IFn$_invoke$arity$1(trace),new cljs.core.Keyword(null,"layer","layer",-1601820589)], null),(cljs.core.truth_(cljs.core.some((function (p1__33462_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(app_db_id,p1__33462_SHARP_);
...
})),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__33467){
var vec__33470 = p__33467;
...
var new_state = (function (){var G__33480 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
break;
case "sub/run":
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(state,reaction_id,((function (G__33480,G__33480__$1,tags,reaction_id,state){
...
});})(G__33480,G__33480__$1,tags,reaction_id,state))
);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__33480__$1)].join('')));
...
return (function (all_state,p__33484){
var vec__33488 = p__33484;
var sub_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33488,(0),null);
var sub_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33488,(1),null);
