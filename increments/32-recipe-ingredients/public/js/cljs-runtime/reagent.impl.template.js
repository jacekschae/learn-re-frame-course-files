...
var G__22411 = o;
(G__22411[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__22423 = props;
var G__22423__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22423,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22423);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22423__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
var G__22444 = jsprops;
(G__22444["defaultValue"] = value);

(G__22444["onChange"] = ((function (G__22444,v,value,on_change){
return (function (p1__22438_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__22438_SHARP_);
});})(G__22444,v,value,on_change))
);
...
var vec__22450 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22450,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22450,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22450,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___22499 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___22499 == null)){
} else {
var key_22500 = temp__5461__auto___22499;
(jsprops["key"] = key_22500);
}
...
var temp__5461__auto___22503 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___22503 == null)){
} else {
var key_22504 = temp__5461__auto___22503;
reagent.impl.template.oset(jsprops,"key",key_22504);
}
...
var G__22456 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__22456) : reagent.impl.template.as_element.call(null,G__22456));
} else {
...
var n__4607__auto___22546 = a.length;
var i_22548 = (0);
while(true){
if((i_22548 < n__4607__auto___22546)){
(a[i_22548] = reagent.impl.template.as_element((a[i_22548])));

var G__22552 = (i_22548 + (1));
i_22548 = G__22552;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___22554 = a.length;
var i_22555 = (0);
while(true){
if((i_22555 < n__4607__auto___22554)){
var val_22557 = (a[i_22555]);
if(((cljs.core.vector_QMARK_(val_22557)) && ((reagent.impl.template.key_from_vec(val_22557) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_22555] = reagent.impl.template.as_element(val_22557));

var G__22560 = (i_22555 + (1));
i_22555 = G__22560;
continue;
} else {
}
