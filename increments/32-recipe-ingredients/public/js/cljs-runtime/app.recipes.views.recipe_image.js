...
var map__26081 = cljs.core.deref((function (){var G__26082 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"recipe","recipe",-17826617)], null);
...
var img = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26081__$1,new cljs.core.Keyword(null,"img","img",1442687358));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26081__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var author_QMARK_ = (function (){var G__26084 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"author?","author?",-1083349935)], null);
...
var open_modal = ((function (initial_values,values,map__26081,map__26081__$1,img,name,author_QMARK_){
...
var modal_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26086__$1,new cljs.core.Keyword(null,"modal-name","modal-name",-2096322394));
var recipe = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26086__$1,new cljs.core.Keyword(null,"recipe","recipe",-17826617));
var G__26088_26091 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"open-modal","open-modal",947793572),modal_name], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__26088_26091) : re_frame.core.dispatch.call(null,G__26088_26091));

return cljs.core.reset_BANG_(values,recipe);
});})(initial_values,values,map__26081,map__26081__$1,img,name,author_QMARK_))
;
var save = ((function (initial_values,values,map__26081,map__26081__$1,img,name,author_QMARK_,open_modal){
return (function (img__$1){
var G__26089_26092 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"upsert-image","upsert-image",304504604),img__$1], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__26089_26092) : re_frame.core.dispatch.call(null,G__26089_26092));

return cljs.core.reset_BANG_(values,initial_values);
});})(initial_values,values,map__26081,map__26081__$1,img,name,author_QMARK_,open_modal))
;
return ((function (initial_values,values,map__26081,map__26081__$1,img,name,author_QMARK_,open_modal,save){
return (function (){
...
})()),")"].join(''),new cljs.core.Keyword(null,"background-size","background-size",-1248630243),"cover",new cljs.core.Keyword(null,"min-height","min-height",398480837),"400px",new cljs.core.Keyword(null,"border-radius","border-radius",419594011),(10),new cljs.core.Keyword(null,"alt","alt",-3214426),name,new cljs.core.Keyword(null,"on-click","on-click",1632826543),(cljs.core.truth_(author_QMARK_)?((function (initial_values,values,map__26081,map__26081__$1,img,name,author_QMARK_,open_modal,save){
return (function (){
...
,new cljs.core.Keyword(null,"variant","variant",-424354234),"light"], null),"Cancel"], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Button,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (initial_values,values,map__26081,map__26081__$1,img,name,author_QMARK_,open_modal,save){
return (function (){
