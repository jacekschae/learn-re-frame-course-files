...
var active_page = cljs.core.deref((function (){var G__25966 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"active-page","active-page",370357330)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__25966) : re_frame.core.subscribe.call(null,G__25966));
})());
var nav_items = new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"saved","saved",288760660),new cljs.core.Keyword(null,"name","name",1843675177),"Saved",new cljs.core.Keyword(null,"href","href",-793805698),(function (){var G__25967 = new cljs.core.Keyword(null,"saved","saved",288760660);
return (app.router.path_for.cljs$core$IFn$_invoke$arity$1 ? app.router.path_for.cljs$core$IFn$_invoke$arity$1(G__25967) : app.router.path_for.call(null,G__25967));
})(),new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),((function (active_page){
return (function (){
var G__25968 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-active-nav","set-active-nav",-1041462259),new cljs.core.Keyword(null,"saved","saved",288760660)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__25968) : re_frame.core.dispatch.call(null,G__25968));
});})(active_page))
], null),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"recipes","recipes",-325236209),new cljs.core.Keyword(null,"name","name",1843675177),"Recipes",new cljs.core.Keyword(null,"href","href",-793805698),(function (){var G__25969 = new cljs.core.Keyword(null,"recipes","recipes",-325236209);
...
], null),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"inboxes","inboxes",-619615989),new cljs.core.Keyword(null,"name","name",1843675177),"Inbox",new cljs.core.Keyword(null,"href","href",-793805698),(function (){var G__25971 = new cljs.core.Keyword(null,"inboxes","inboxes",-619615989);
...
return (function (){
var G__25972 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-active-nav","set-active-nav",-1041462259),new cljs.core.Keyword(null,"inboxes","inboxes",-619615989)], null);
...
], null),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"profile","profile",-545963874),new cljs.core.Keyword(null,"name","name",1843675177),"Profile",new cljs.core.Keyword(null,"href","href",-793805698),(function (){var G__25975 = new cljs.core.Keyword(null,"profile","profile",-545963874);
...
return (function (){
var G__25976 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-active-nav","set-active-nav",-1041462259),new cljs.core.Keyword(null,"profile","profile",-545963874)], null);
...
return (function app$nav$views$authenticated$authenticated_$_iter__25977(s__25978){
return (new cljs.core.LazySeq(null,((function (active_page,nav_items){
return (function (){
var s__25978__$1 = s__25978;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__25978__$1);
if(temp__5457__auto__){
var s__25978__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__25978__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__25978__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__25980 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__25979 = (0);
while(true){
if((i__25979 < size__4522__auto__)){
var map__26000 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__25979);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__25980),app$nav$views$authenticated$authenticated_$_iter__25977(cljs.core.chunk_rest(s__25978__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__25980),null);
}
} else {
var map__26017 = cljs.core.first(s__25978__$2);
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26017__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26017__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var href = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26017__$1,new cljs.core.Keyword(null,"href","href",-793805698));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26017__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [app.nav.views.nav_item.nav_item,new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"key","key",-1516042587),id,new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"name","name",1843675177),name,new cljs.core.Keyword(null,"href","href",-793805698),href,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),dispatch,new cljs.core.Keyword(null,"active-page","active-page",370357330),active_page], null)], null),app$nav$views$authenticated$authenticated_$_iter__25977(cljs.core.rest(s__25978__$2)));
}
} else {
return null;
}
