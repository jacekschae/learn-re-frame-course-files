...
/** @this {Function} */
cljs.tools.reader.impl.errors.throw_ex.cljs$lang$applyTo = (function (seq25965){
var G__25966 = cljs.core.first(seq25965);
var seq25965__$1 = cljs.core.next(seq25965);
var G__25967 = cljs.core.first(seq25965__$1);
var seq25965__$2 = cljs.core.next(seq25965__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25966,G__25967,seq25965__$2);
});
...
/** @this {Function} */
cljs.tools.reader.impl.errors.reader_error.cljs$lang$applyTo = (function (seq25982){
...
/** @this {Function} */
cljs.tools.reader.impl.errors.illegal_arg_error.cljs$lang$applyTo = (function (seq25992){
var G__25993 = cljs.core.first(seq25992);
var seq25992__$1 = cljs.core.next(seq25992);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25993,seq25992__$1);
});
...
/** @this {Function} */
cljs.tools.reader.impl.errors.eof_error.cljs$lang$applyTo = (function (seq26006){
var G__26007 = cljs.core.first(seq26006);
var seq26006__$1 = cljs.core.next(seq26006);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26007,seq26006__$1);
});
...
var init = (function (){var G__26046 = kind;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26046__$1)].join('')));
...
/** @this {Function} */
cljs.tools.reader.impl.errors.throw_eof_reading.cljs$lang$applyTo = (function (seq26042){
...
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26043,G__26044,seq26042__$2);
});
...
var iter__4523__auto__ = (function cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__26097(s__26098){
return (new cljs.core.LazySeq(null,(function (){
var s__26098__$1 = s__26098;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__26098__$1);
if(temp__5457__auto__){
var s__26098__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26098__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__26098__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__26100 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__26099 = (0);
while(true){
if((i__26099 < size__4522__auto__)){
var vec__26101 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__26099);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26101,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26101,(1),null);
if((freq > (1))){
cljs.core.chunk_append(b__26100,id);

var G__26135 = (i__26099 + (1));
i__26099 = G__26135;
continue;
} else {
var G__26136 = (i__26099 + (1));
i__26099 = G__26136;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26100),cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__26097(cljs.core.chunk_rest(s__26098__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26100),null);
}
} else {
var vec__26105 = cljs.core.first(s__26098__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26105,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26105,(1),null);
if((freq > (1))){
return cljs.core.cons(id,cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__26097(cljs.core.rest(s__26098__$2)));
} else {
var G__26138 = cljs.core.rest(s__26098__$2);
s__26098__$1 = G__26138;
continue;
}
}
} else {
