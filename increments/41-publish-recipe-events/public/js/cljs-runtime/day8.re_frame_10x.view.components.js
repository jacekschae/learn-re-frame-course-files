...
day8.re_frame_10x.view.components.search_input = (function day8$re_frame_10x$view$components$search_input(p__22004){
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22005__$1,new cljs.core.Keyword(null,"title","title",636505583));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22005__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var on_save = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22005__$1,new cljs.core.Keyword(null,"on-save","on-save",1618176266));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22005__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var on_stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22005__$1,new cljs.core.Keyword(null,"on-stop","on-stop",1520114515));
var val = mranderson048.reagent.v0v8v0.reagent.core.atom.cljs$core$IFn$_invoke$arity$1(title);
var save = ((function (val,map__22005,map__22005__$1,title,placeholder,on_save,on_change,on_stop){
return (function (){
...
});})(val,map__22005,map__22005__$1,title,placeholder,on_save,on_change,on_stop))
;
return ((function (val,save,map__22005,map__22005__$1,title,placeholder,on_save,on_change,on_stop){
return (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(val),new cljs.core.Keyword(null,"auto-focus","auto-focus",1250006231),true,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),placeholder,new cljs.core.Keyword(null,"size","size",1098693007),((((20) > cljs.core.count(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(val)))))?(25):cljs.core.count(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(val)))),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (val,save,map__22005,map__22005__$1,title,placeholder,on_save,on_change,on_stop){
return (function (p1__22001_SHARP_){
cljs.core.reset_BANG_(val,p1__22001_SHARP_.target.value);

return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(p1__22001_SHARP_) : on_change.call(null,p1__22001_SHARP_));
});})(val,save,map__22005,map__22005__$1,title,placeholder,on_save,on_change,on_stop))
,new cljs.core.Keyword(null,"on-key-down","on-key-down",-1374733765),((function (val,save,map__22005,map__22005__$1,title,placeholder,on_save,on_change,on_stop){
return (function (p1__22002_SHARP_){
var G__22013 = p1__22002_SHARP_.which;
switch (G__22013) {
case (13):
save();
...
day8.re_frame_10x.view.components.autoscroll_list = (function day8$re_frame_10x$view$components$autoscroll_list(p__22019,child){
var map__22020 = p__22019;
var map__22020__$1 = (((((!((map__22020 == null))))?(((((map__22020.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22020.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22020):map__22020);
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22020__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var scroll_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22020__$1,new cljs.core.Keyword(null,"scroll?","scroll?",-1393045951));
...
return mranderson048.reagent.v0v8v0.reagent.core.create_class(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"display-name","display-name",694513143),"autoscroll-list",new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),((function (node,should_scroll,map__22020,map__22020__$1,class$,scroll_QMARK_){
return (function (_){
...
});})(node,should_scroll,map__22020,map__22020__$1,class$,scroll_QMARK_))
,new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),((function (node,should_scroll,map__22020,map__22020__$1,class$,scroll_QMARK_){
return (function (_){
...
,new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),((function (node,should_scroll,map__22020,map__22020__$1,class$,scroll_QMARK_){
return (function (_){
...
,new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),((function (node,should_scroll,map__22020,map__22020__$1,class$,scroll_QMARK_){
return (function (p__22026,child__$1){
...
var class$__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22027__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),class$__$1,new cljs.core.Keyword(null,"ref","ref",1289896967),((function (map__22027,map__22027__$1,class$__$1,node,should_scroll,map__22020,map__22020__$1,class$,scroll_QMARK_){
return (function (dom_node){
return cljs.core.reset_BANG_(node,dom_node);
});})(map__22027,map__22027__$1,class$__$1,node,should_scroll,map__22020,map__22020__$1,class$,scroll_QMARK_))
], null),child__$1], null);
});})(node,should_scroll,map__22020,map__22020__$1,class$,scroll_QMARK_))
], null));
});
...
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22031_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__22031_SHARP_,/:/);
...
var G__22144 = (i__4731__auto___22142 + (1));
i__4731__auto___22142 = G__22144;
continue;
} else {
}
break;
...
var previous_config__21991__auto__ = devtools.prefs.get_prefs();
var prefs__21992__auto__ = day8.re_frame_10x.view.components.effective_cljs_devtools_prefs;
try{devtools.prefs.set_prefs_BANG_(prefs__21992__auto__);

return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(api_fn,args);
}finally {if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.prefs.get_prefs(),prefs__21992__auto__)){
} else {
throw (new Error(["Assert failed: ","someone modified devtools.prefs behind our back!","\n","(clojure.core/= (devtools.prefs/get-prefs) prefs__21992__auto__)"].join('')));
}

devtools.prefs.set_prefs_BANG_(previous_config__21991__auto__);
}});
...
var G__22152 = (i__4731__auto___22149 + (1));
i__4731__auto___22149 = G__22152;
continue;
} else {
}
break;
...
var args__4736__auto__ = [];
var len__4730__auto___22156 = arguments.length;
var i__4731__auto___22157 = (0);
while(true){
if((i__4731__auto___22157 < len__4730__auto___22156)){
args__4736__auto__.push((arguments[i__4731__auto___22157]));

var G__22160 = (i__4731__auto___22157 + (1));
i__4731__auto___22157 = G__22160;
continue;
} else {
}
break;
...
var expanded_QMARK_ = (function (){var G__22043 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","node-expanded?","app-db/node-expanded?",-1032853540),path], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__22043) : mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.call(null,G__22043));
})();
...
var vec__22055 = jsonml;
var seq__22056 = cljs.core.seq(vec__22055);
var first__22057 = cljs.core.first(seq__22056);
var seq__22056__$1 = cljs.core.next(seq__22056);
var tag_name = first__22057;
var first__22057__$1 = cljs.core.first(seq__22056__$1);
var seq__22056__$2 = cljs.core.next(seq__22056__$1);
var attributes = first__22057__$1;
var children = seq__22056__$2;
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(tag_name),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),day8.re_frame_10x.view.components.string__GT_css(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(attributes),"style"))], null)], null),cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$1(((function (vec__22055,seq__22056,first__22057,seq__22056__$1,tag_name,first__22057__$1,seq__22056__$2,attributes,children,tagnames){
return (function (i,child){
var G__22059 = child;
var G__22060 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path,i);
return (day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2(G__22059,G__22060) : day8.re_frame_10x.view.components.jsonml__GT_hiccup.call(null,G__22059,G__22060));
});})(vec__22055,seq__22056,first__22057,seq__22056__$1,tag_name,first__22057__$1,seq__22056__$2,attributes,children,tagnames))
),children);
} else {
...
var expanded_QMARK_ = (function (){var G__22065 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","node-expanded?","app-db/node-expanded?",-1032853540),path], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__22065) : mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.call(null,G__22065));
})();
return ((function (expanded_QMARK_){
...
return (function (){
var G__22067 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","toggle-expansion","app-db/toggle-expansion",-1617765538),path], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__22067) : mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.call(null,G__22067));
});})(expanded_QMARK_))
...
var args__4736__auto__ = [];
var len__4730__auto___22187 = arguments.length;
var i__4731__auto___22188 = (0);
while(true){
if((i__4731__auto___22188 < len__4730__auto___22187)){
args__4736__auto__.push((arguments[i__4731__auto___22188]));

var G__22189 = (i__4731__auto___22188 + (1));
i__4731__auto___22188 = G__22189;
continue;
} else {
}
break;
...
day8.re_frame_10x.view.components.simple_render.cljs$core$IFn$_invoke$arity$variadic = (function (data,path,p__22087){
var vec__22088 = p__22087;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22088,(0),null);
var expanded_QMARK_ = mranderson048.reagent.v0v8v0.reagent.core.atom.cljs$core$IFn$_invoke$arity$1(true);
return ((function (expanded_QMARK_,vec__22088,class$){
return (function (data__$1){
...
;})(expanded_QMARK_,vec__22088,class$))
});

day8.re_frame_10x.view.components.simple_render.cljs$lang$maxFixedArity = (2);

/** @this {Function} */
day8.re_frame_10x.view.components.simple_render.cljs$lang$applyTo = (function (seq22081){
...
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22082,G__22083,seq22081__$2);
});
