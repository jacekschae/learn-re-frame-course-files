...
return [(function (){var pred__20962 = cljs.core.instance_QMARK_;
var expr__20963 = reactive_val;
if(cljs.core.truth_((pred__20962.cljs$core$IFn$_invoke$arity$2 ? pred__20962.cljs$core$IFn$_invoke$arity$2(mranderson048.reagent.v0v8v0.reagent.ratom.RAtom,expr__20963) : pred__20962.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.RAtom,expr__20963)))){
return "ra";
} else {
if(cljs.core.truth_((pred__20962.cljs$core$IFn$_invoke$arity$2 ? pred__20962.cljs$core$IFn$_invoke$arity$2(mranderson048.reagent.v0v8v0.reagent.ratom.RCursor,expr__20963) : pred__20962.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.RCursor,expr__20963)))){
return "rc";
} else {
if(cljs.core.truth_((pred__20962.cljs$core$IFn$_invoke$arity$2 ? pred__20962.cljs$core$IFn$_invoke$arity$2(mranderson048.reagent.v0v8v0.reagent.ratom.Reaction,expr__20963) : pred__20962.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.Reaction,expr__20963)))){
return "rx";
} else {
if(cljs.core.truth_((pred__20962.cljs$core$IFn$_invoke$arity$2 ? pred__20962.cljs$core$IFn$_invoke$arity$2(mranderson048.reagent.v0v8v0.reagent.ratom.Track,expr__20963) : pred__20962.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.Track,expr__20963)))){
return "tr";
} else {
return "other";
}
