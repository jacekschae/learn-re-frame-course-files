...
var modal_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26083__$1,new cljs.core.Keyword(null,"modal-name","modal-name",-2096322394));
var recipe = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26083__$1,new cljs.core.Keyword(null,"recipe","recipe",-17826617));
var G__26085_26096 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"open-modal","open-modal",947793572),modal_name], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__26085_26096) : re_frame.core.dispatch.call(null,G__26085_26096));

return cljs.core.reset_BANG_(values,recipe);
});})(initial_values,values))
;
var save = ((function (initial_values,values,open_modal){
return (function (p__26086){
...
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26087__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var prep_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26087__$1,new cljs.core.Keyword(null,"prep-time","prep-time",-2097570172));
var G__26089_26101 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"upsert-recipe","upsert-recipe",-378628019),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),clojure.string.trim(name),new cljs.core.Keyword(null,"prep-time","prep-time",-2097570172),parseInt(prep_time)], null)], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__26089_26101) : re_frame.core.dispatch.call(null,G__26089_26101));
...
return (function (){
var map__26090 = cljs.core.deref((function (){var G__26091 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"recipe","recipe",-17826617)], null);
...
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26090__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var prep_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26090__$1,new cljs.core.Keyword(null,"prep-time","prep-time",-2097570172));
var active_page = cljs.core.deref((function (){var G__26093 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"active-page","active-page",370357330)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__26093) : re_frame.core.subscribe.call(null,G__26093));
})());
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(active_page,new cljs.core.Keyword(null,"recipe","recipe",-17826617)))?new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Typography,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"variant","variant",-424354234),"h2",new cljs.core.Keyword(null,"class","class",-2030961996),"editable",new cljs.core.Keyword(null,"font-weight","font-weight",2085804583),(700),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__26090,map__26090__$1,name,prep_time,active_page,initial_values,values,open_modal,save){
return (function (){
...
});})(map__26090,map__26090__$1,name,prep_time,active_page,initial_values,values,open_modal,save))
], null),name], null):new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Button,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__26090,map__26090__$1,name,prep_time,active_page,initial_values,values,open_modal,save){
return (function (){
...
], null),"Delete"], null):null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Button,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"variant","variant",-424354234),"light",new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__26090,map__26090__$1,name,prep_time,active_page,initial_values,values,open_modal,save){
return (function (){
var G__26095 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"close-modal","close-modal",-1882189985)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__26095) : re_frame.core.dispatch.call(null,G__26095));
});})(map__26090,map__26090__$1,name,prep_time,active_page,initial_values,values,open_modal,save))
