...
var G__22426 = o;
(G__22426[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
G__22508.cljs$lang$applyTo = (function (arglist__22512){
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__22442){
var map__22443 = p__22442;
var map__22443__$1 = (((((!((map__22443 == null))))?(((((map__22443.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22443.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22443):map__22443);
var props = map__22443__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22443__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__22443,map__22443__$1,props,class$){
return (function (c){
...
});})(map__22443,map__22443__$1,props,class$))
,class$)));
} else {
return props;
}
...
var G__22451 = jsprops;
(G__22451["defaultValue"] = value);

(G__22451["onChange"] = ((function (G__22451,v,value,on_change){
return (function (p1__22449_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__22449_SHARP_);
});})(G__22451,v,value,on_change))
);
...
var jsprops = ({"argv": v});
var temp__5461__auto___22549 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___22549 == null)){
} else {
var key_22550 = temp__5461__auto___22549;
(jsprops["key"] = key_22550);
}
...
var temp__5461__auto___22551 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___22551 == null)){
} else {
var key_22552 = temp__5461__auto___22551;
reagent.impl.template.oset(jsprops,"key",key_22552);
}
...
var G__22459 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__22459) : reagent.impl.template.as_element.call(null,G__22459));
} else {
...
var len__4730__auto___22555 = arguments.length;
var i__4731__auto___22557 = (0);
while(true){
if((i__4731__auto___22557 < len__4730__auto___22555)){
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq22463){
var G__22464 = cljs.core.first(seq22463);
var seq22463__$1 = cljs.core.next(seq22463);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22464,seq22463__$1);
});
...
break;
default:
var G__22568 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__22568;
continue;
...
(a[i_22575] = reagent.impl.template.as_element((a[i_22575])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___22582 = a.length;
var i_22583 = (0);
while(true){
if((i_22583 < n__4607__auto___22582)){
var val_22585 = (a[i_22583]);
if(((cljs.core.vector_QMARK_(val_22585)) && ((reagent.impl.template.key_from_vec(val_22585) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_22583] = reagent.impl.template.as_element(val_22585));

var G__22586 = (i_22583 + (1));
i_22583 = G__22586;
continue;
} else {
}
...
var ctx = ({});
var vec__22474 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22474,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22474,(1),null);
...
var G__22480 = (cljs.core.count(argv) - first_child);
switch (G__22480) {
case (0):
...
case (1):
var G__22482 = comp;
var G__22483 = jsprops;
var G__22484 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__22482,G__22483,G__22484);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__22480){
