...
return [(function (){var pred__22637 = cljs.core.instance_QMARK_;
var expr__22638 = reactive_val;
if(cljs.core.truth_((pred__22637.cljs$core$IFn$_invoke$arity$2 ? pred__22637.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__22638) : pred__22637.call(null,reagent.ratom.RAtom,expr__22638)))){
return "ra";
} else {
if(cljs.core.truth_((pred__22637.cljs$core$IFn$_invoke$arity$2 ? pred__22637.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__22638) : pred__22637.call(null,reagent.ratom.RCursor,expr__22638)))){
return "rc";
} else {
if(cljs.core.truth_((pred__22637.cljs$core$IFn$_invoke$arity$2 ? pred__22637.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__22638) : pred__22637.call(null,reagent.ratom.Reaction,expr__22638)))){
return "rx";
} else {
if(cljs.core.truth_((pred__22637.cljs$core$IFn$_invoke$arity$2 ? pred__22637.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__22638) : pred__22637.call(null,reagent.ratom.Track,expr__22638)))){
return "tr";
} else {
return "other";
}
