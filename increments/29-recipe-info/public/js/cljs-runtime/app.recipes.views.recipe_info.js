...
var map__27493 = cljs.core.deref((function (){var G__27495 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"recipe","recipe",-17826617)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__27495) : re_frame.core.subscribe.call(null,G__27495));
})());
var map__27493__$1 = (((((!((map__27493 == null))))?(((((map__27493.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27493.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27493):map__27493);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27493__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var cook = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27493__$1,new cljs.core.Keyword(null,"cook","cook",1825923808));
var saved_count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27493__$1,new cljs.core.Keyword(null,"saved-count","saved-count",1526301101));
var prep_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27493__$1,new cljs.core.Keyword(null,"prep-time","prep-time",-2097570172));
var map__27494 = cljs.core.deref((function (){var G__27497 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user","user",1532431356)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__27497) : re_frame.core.subscribe.call(null,G__27497));
})());
...
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27494__$1,new cljs.core.Keyword(null,"uid","uid",-1447769400));
var saved = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27494__$1,new cljs.core.Keyword(null,"saved","saved",288760660));
var logged_in_QMARK_ = cljs.core.deref((function (){var G__27499 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"logged-in?","logged-in?",-661271089)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__27499) : re_frame.core.subscribe.call(null,G__27499));
})());
