...
}catch (e24366){var _e__21929__auto__ = e24366;
return false;
...
}catch (e24376){var _e__21929__auto__ = e24376;
return false;
...
}catch (e24390){var _e__21929__auto__ = e24390;
return false;
...
}catch (e24392){var _e__21929__auto__ = e24392;
return false;
...
}catch (e24398){var _e__21929__auto__ = e24398;
return false;
}})())){
...
}catch (e24405){var _e__21929__auto__ = e24405;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__24411 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__24412 = (function (){var or__4131__auto__ = config;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__24412;

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__24411;
}});
});
...
while (G__24452__i < G__24452__a.length) {G__24452__a[G__24452__i] = arguments[G__24452__i + 0]; ++G__24452__i;}
  args = new cljs.core.IndexedSeq(G__24452__a,0,null);
} 
