...
var G__26345 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__26345;
continue;
} else {
return ch;
...
var vec__26303 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26303,(0),null);
return (match === s);
});
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq26338){
...
return (function() { 
var G__26356__delegate = function (rdr,_){
...
var G__26356 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__26357__i = 0, G__26357__a = new Array(arguments.length -  1);
while (G__26357__i < G__26357__a.length) {G__26357__a[G__26357__i] = arguments[G__26357__i + 1]; ++G__26357__i;}
  _ = new cljs.core.IndexedSeq(G__26357__a,0,null);
} 
return G__26356__delegate.call(this,rdr,_);};
G__26356.cljs$lang$maxFixedArity = 1;
G__26356.cljs$lang$applyTo = (function (arglist__26358){
var rdr = cljs.core.first(arglist__26358);
var _ = cljs.core.rest(arglist__26358);
return G__26356__delegate(rdr,_);
});
