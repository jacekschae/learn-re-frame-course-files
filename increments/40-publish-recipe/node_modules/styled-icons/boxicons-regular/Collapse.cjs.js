...
var StyledIcon = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement("svg", __assign({}, iconProps, svgProps, { ref: ref }),
        props.title && React.createElement("title", { key: "Collapse-title" }, props.title),
        React.createElement("path", { d: "M4.707 20.707l3.172-3.172L10 19.656V14H4.344l2.121 2.121-3.172 3.172zM19.293 3.293l-3.172 3.172L14 4.344V10h5.656l-2.121-2.121 3.172-3.172zM14 14v5.656l2.121-2.121 3.172 3.172 1.414-1.414-3.172-3.172L19.656 14zm-4-9.656L7.879 6.465 4.707 3.293 3.293 4.707l3.172 3.172L4.344 10H10z", key: "k0" })));
});
exports.Collapse = styled_components_1.default(StyledIcon)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  display: inline-block;\n  vertical-align: middle;\n  overflow: hidden;\n"], ["\n  display: inline-block;\n  vertical-align: middle;\n  overflow: hidden;\n"])));
