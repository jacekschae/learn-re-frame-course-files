...
day8.re_frame_10x.view.components.search_input = (function day8$re_frame_10x$view$components$search_input(p__22002){
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22003__$1,new cljs.core.Keyword(null,"title","title",636505583));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22003__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var on_save = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22003__$1,new cljs.core.Keyword(null,"on-save","on-save",1618176266));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22003__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var on_stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22003__$1,new cljs.core.Keyword(null,"on-stop","on-stop",1520114515));
var val = mranderson048.reagent.v0v8v0.reagent.core.atom.cljs$core$IFn$_invoke$arity$1(title);
var save = ((function (val,map__22003,map__22003__$1,title,placeholder,on_save,on_change,on_stop){
return (function (){
...
});})(val,map__22003,map__22003__$1,title,placeholder,on_save,on_change,on_stop))
;
return ((function (val,save,map__22003,map__22003__$1,title,placeholder,on_save,on_change,on_stop){
return (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(val),new cljs.core.Keyword(null,"auto-focus","auto-focus",1250006231),true,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),placeholder,new cljs.core.Keyword(null,"size","size",1098693007),((((20) > cljs.core.count(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(val)))))?(25):cljs.core.count(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(val)))),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (val,save,map__22003,map__22003__$1,title,placeholder,on_save,on_change,on_stop){
return (function (p1__21999_SHARP_){
cljs.core.reset_BANG_(val,p1__21999_SHARP_.target.value);

return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(p1__21999_SHARP_) : on_change.call(null,p1__21999_SHARP_));
});})(val,save,map__22003,map__22003__$1,title,placeholder,on_save,on_change,on_stop))
,new cljs.core.Keyword(null,"on-key-down","on-key-down",-1374733765),((function (val,save,map__22003,map__22003__$1,title,placeholder,on_save,on_change,on_stop){
return (function (p1__22000_SHARP_){
var G__22009 = p1__22000_SHARP_.which;
switch (G__22009) {
case (13):
save();
...
day8.re_frame_10x.view.components.autoscroll_list = (function day8$re_frame_10x$view$components$autoscroll_list(p__22015,child){
var map__22017 = p__22015;
var map__22017__$1 = (((((!((map__22017 == null))))?(((((map__22017.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22017.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22017):map__22017);
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22017__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var scroll_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22017__$1,new cljs.core.Keyword(null,"scroll?","scroll?",-1393045951));
...
return mranderson048.reagent.v0v8v0.reagent.core.create_class(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"display-name","display-name",694513143),"autoscroll-list",new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),((function (node,should_scroll,map__22017,map__22017__$1,class$,scroll_QMARK_){
return (function (_){
...
});})(node,should_scroll,map__22017,map__22017__$1,class$,scroll_QMARK_))
,new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),((function (node,should_scroll,map__22017,map__22017__$1,class$,scroll_QMARK_){
return (function (_){
...
,new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),((function (node,should_scroll,map__22017,map__22017__$1,class$,scroll_QMARK_){
return (function (_){
...
,new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),((function (node,should_scroll,map__22017,map__22017__$1,class$,scroll_QMARK_){
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),class$__$1,new cljs.core.Keyword(null,"ref","ref",1289896967),((function (map__22023,map__22023__$1,class$__$1,node,should_scroll,map__22017,map__22017__$1,class$,scroll_QMARK_){
return (function (dom_node){
return cljs.core.reset_BANG_(node,dom_node);
});})(map__22023,map__22023__$1,class$__$1,node,should_scroll,map__22017,map__22017__$1,class$,scroll_QMARK_))
], null),child__$1], null);
});})(node,should_scroll,map__22017,map__22017__$1,class$,scroll_QMARK_))
], null));
});
...
var len__4730__auto___22080 = arguments.length;
var i__4731__auto___22081 = (0);
while(true){
if((i__4731__auto___22081 < len__4730__auto___22080)){
args__4736__auto__.push((arguments[i__4731__auto___22081]));

var G__22082 = (i__4731__auto___22081 + (1));
i__4731__auto___22081 = G__22082;
continue;
} else {
}
break;
...
var previous_config__21989__auto__ = devtools.prefs.get_prefs();
var prefs__21990__auto__ = day8.re_frame_10x.view.components.effective_cljs_devtools_prefs;
try{devtools.prefs.set_prefs_BANG_(prefs__21990__auto__);

return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(api_fn,args);
}finally {if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.prefs.get_prefs(),prefs__21990__auto__)){
} else {
throw (new Error(["Assert failed: ","someone modified devtools.prefs behind our back!","\n","(clojure.core/= (devtools.prefs/get-prefs) prefs__21990__auto__)"].join('')));
}

devtools.prefs.set_prefs_BANG_(previous_config__21989__auto__);
}});
...
var args__4736__auto__ = [];
var len__4730__auto___22088 = arguments.length;
var i__4731__auto___22089 = (0);
while(true){
if((i__4731__auto___22089 < len__4730__auto___22088)){
args__4736__auto__.push((arguments[i__4731__auto___22089]));

var G__22090 = (i__4731__auto___22089 + (1));
i__4731__auto___22089 = G__22090;
continue;
} else {
}
break;
...
var args__4736__auto__ = [];
var len__4730__auto___22096 = arguments.length;
var i__4731__auto___22097 = (0);
while(true){
if((i__4731__auto___22097 < len__4730__auto___22096)){
args__4736__auto__.push((arguments[i__4731__auto___22097]));

var G__22098 = (i__4731__auto___22097 + (1));
i__4731__auto___22097 = G__22098;
continue;
} else {
}
break;
...
var G__22121 = (i__4731__auto___22119 + (1));
i__4731__auto___22119 = G__22121;
continue;
} else {
}
break;
