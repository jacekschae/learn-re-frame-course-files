...
var map__26103 = cljs.core.deref((function (){var G__26105 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"recipe","recipe",-17826617)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__26105) : re_frame.core.subscribe.call(null,G__26105));
})());
...
var cook = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26103__$1,new cljs.core.Keyword(null,"cook","cook",1825923808));
var saved_count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26103__$1,new cljs.core.Keyword(null,"saved-count","saved-count",1526301101));
var prep_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26103__$1,new cljs.core.Keyword(null,"prep-time","prep-time",-2097570172));
var map__26104 = cljs.core.deref((function (){var G__26107 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"user","user",1532431356)], null);
...
var saved = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26104__$1,new cljs.core.Keyword(null,"saved","saved",288760660));
var logged_in_QMARK_ = cljs.core.deref((function (){var G__26111 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"logged-in?","logged-in?",-661271089)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__26111) : re_frame.core.subscribe.call(null,G__26111));
})());
var saved_QMARK_ = cljs.core.contains_QMARK_(saved,id);
var author_QMARK_ = (function (){var G__26114 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"author?","author?",-1083349935)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__26114) : re_frame.core.subscribe.call(null,G__26114));
})();
