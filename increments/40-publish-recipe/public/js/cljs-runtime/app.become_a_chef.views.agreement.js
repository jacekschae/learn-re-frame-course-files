...
var logged_in_QMARK_ = cljs.core.deref((function (){var G__25979 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"logged-in?","logged-in?",-661271089)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__25979) : re_frame.core.subscribe.call(null,G__25979));
})());
...
return (function (){
var G__25980 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"open-modal","open-modal",947793572),new cljs.core.Keyword(null,"agreement","agreement",-156381462)], null);
...
return (function (){
var G__25981 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"close-modal","close-modal",-1882189985)], null);
...
return (function (){
var G__25982 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"agree-to-cook","agree-to-cook",188697388)], null);
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Button,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"as","as",1148689641),"a",new cljs.core.Keyword(null,"color","color",1011675173),"white",new cljs.core.Keyword(null,"href","href",-793805698),(function (){var G__25983 = new cljs.core.Keyword(null,"sign-up","sign-up",-1190725688);
return (app.router.path_for.cljs$core$IFn$_invoke$arity$1 ? app.router.path_for.cljs$core$IFn$_invoke$arity$1(G__25983) : app.router.path_for.call(null,G__25983));
})(),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (logged_in_QMARK_){
return (function (){
var G__25984 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-active-nav","set-active-nav",-1041462259),new cljs.core.Keyword(null,"sign-up","sign-up",-1190725688)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__25984) : re_frame.core.dispatch.call(null,G__25984));
});})(logged_in_QMARK_))
], null),"Sign up"], null);
}
});
