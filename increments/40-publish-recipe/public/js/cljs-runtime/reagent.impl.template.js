...
var G__22410 = o;
(G__22410[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__22416 = o;
(G__22416[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__22424 = props;
var G__22424__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22424,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22424);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22424__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__22428){
var map__22429 = p__22428;
var map__22429__$1 = (((((!((map__22429 == null))))?(((((map__22429.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22429.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22429):map__22429);
var props = map__22429__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22429__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__22429,map__22429__$1,props,class$){
return (function (c){
...
});})(map__22429,map__22429__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__22440){
var map__22441 = p__22440;
var map__22441__$1 = (((((!((map__22441 == null))))?(((((map__22441.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22441.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22441):map__22441);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22441__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__22441,map__22441__$1,on_write){
return (function (){
...
});})(node_value,map__22441,map__22441__$1,on_write))
);
} else {
...
var G__22448 = jsprops;
(G__22448["defaultValue"] = value);

(G__22448["onChange"] = ((function (G__22448,v,value,on_change){
return (function (p1__22447_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__22447_SHARP_);
});})(G__22448,v,value,on_change))
);
...
var vec__22451 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22451,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22451,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22451,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___22506 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___22506 == null)){
} else {
var key_22508 = temp__5461__auto___22506;
(jsprops["key"] = key_22508);
}
...
var key_22522 = temp__5461__auto___22520;
...
var G__22456 = reagent.impl.template.__GT_NativeWrapper();
(G__22456["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq22461){
var G__22462 = cljs.core.first(seq22461);
var seq22461__$1 = cljs.core.next(seq22461);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22462,seq22461__$1);
});
...
break;
default:
var G__22550 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__22550;
continue;
...
var n__4607__auto___22563 = a.length;
var i_22564 = (0);
while(true){
if((i_22564 < n__4607__auto___22563)){
(a[i_22564] = reagent.impl.template.as_element((a[i_22564])));

var G__22568 = (i_22564 + (1));
i_22564 = G__22568;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___22570 = a.length;
var i_22572 = (0);
while(true){
if((i_22572 < n__4607__auto___22570)){
var val_22573 = (a[i_22572]);
if(((cljs.core.vector_QMARK_(val_22573)) && ((reagent.impl.template.key_from_vec(val_22573) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_22572] = reagent.impl.template.as_element(val_22573));

var G__22575 = (i_22572 + (1));
i_22572 = G__22575;
continue;
} else {
}
...
var ctx = ({});
var vec__22465 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22465,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22465,(1),null);
