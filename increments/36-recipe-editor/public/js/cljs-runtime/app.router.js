...
app.router.history = (function (){var dispatch = (function (p1__25895_SHARP_){
var G__25897 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"route-changed","route-changed",455870141),p1__25895_SHARP_], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__25897) : re_frame.core.dispatch.call(null,G__25897));
});
var match = ((function (dispatch){
return (function (p1__25896_SHARP_){
return bidi.bidi.match_route(app.router.routes,p1__25896_SHARP_);
});})(dispatch))
;
