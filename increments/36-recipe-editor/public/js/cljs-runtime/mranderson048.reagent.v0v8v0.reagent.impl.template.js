...
var G__20790 = o;
(G__20790[mranderson048.reagent.v0v8v0.reagent.impl.template.cached_custom_prop_name(k)] = mranderson048.reagent.v0v8v0.reagent.impl.template.convert_prop_value(v));
...
var G__20796 = props;
var G__20796__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20796,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__20796);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20796__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
mranderson048.reagent.v0v8v0.reagent.impl.template.stringify_class = (function mranderson048$reagent$v0v8v0$reagent$impl$template$stringify_class(p__20798){
...
var props = map__20799__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20799__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
mranderson048.reagent.v0v8v0.reagent.impl.template.input_node_set_value = (function mranderson048$reagent$v0v8v0$reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__20803){
var map__20804 = p__20803;
var map__20804__$1 = (((((!((map__20804 == null))))?(((((map__20804.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20804.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__20804):map__20804);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20804__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return mranderson048.reagent.v0v8v0.reagent.impl.batching.do_after_render(((function (node_value,map__20804,map__20804__$1,on_write){
return (function (){
...
});})(node_value,map__20804,map__20804__$1,on_write))
);
} else {
...
while(true){
if((i__4731__auto___20886 < len__4730__auto___20884)){
args__4736__auto__.push((arguments[i__4731__auto___20886]));

var G__20889 = (i__4731__auto___20886 + (1));
i__4731__auto___20886 = G__20889;
continue;
} else {
}
break;
