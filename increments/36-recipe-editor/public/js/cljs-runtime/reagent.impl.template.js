...
var G__22423 = o;
(G__22423[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__22434 = o;
(G__22434[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__22482__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__22482 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__22483__i = 0, G__22483__a = new Array(arguments.length -  0);
while (G__22483__i < G__22483__a.length) {G__22483__a[G__22483__i] = arguments[G__22483__i + 0]; ++G__22483__i;}
  args = new cljs.core.IndexedSeq(G__22483__a,0,null);
} 
return G__22482__delegate.call(this,args);};
G__22482.cljs$lang$maxFixedArity = 0;
G__22482.cljs$lang$applyTo = (function (arglist__22484){
var args = cljs.core.seq(arglist__22484);
return G__22482__delegate(args);
});
...
var G__22440 = props;
var G__22440__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22440,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22440);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22440__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__22441){
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__22442,map__22442__$1,props,class$){
return (function (c){
...
});})(map__22442,map__22442__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__22445){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22446__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__22446,map__22446__$1,on_write){
return (function (){
...
});})(node_value,map__22446,map__22446__$1,on_write))
);
} else {
...
var G__22450 = jsprops;
(G__22450["defaultValue"] = value);

(G__22450["onChange"] = ((function (G__22450,v,value,on_change){
return (function (p1__22449_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__22449_SHARP_);
});})(G__22450,v,value,on_change))
);
...
var vec__22453 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22453,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22453,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22453,(2),null);
...
var temp__5461__auto___22520 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___22520 == null)){
} else {
var key_22521 = temp__5461__auto___22520;
reagent.impl.template.oset(jsprops,"key",key_22521);
}
...
var G__22457 = reagent.impl.template.__GT_NativeWrapper();
(G__22457["name"] = c);
...
var G__22458 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__22458) : reagent.impl.template.as_element.call(null,G__22458));
} else {
...
var len__4730__auto___22533 = arguments.length;
var i__4731__auto___22534 = (0);
while(true){
if((i__4731__auto___22534 < len__4730__auto___22533)){
args__4736__auto__.push((arguments[i__4731__auto___22534]));

var G__22536 = (i__4731__auto___22534 + (1));
i__4731__auto___22534 = G__22536;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq22462){
var G__22463 = cljs.core.first(seq22462);
var seq22462__$1 = cljs.core.next(seq22462);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22463,seq22462__$1);
});
...
break;
default:
var G__22556 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__22556;
continue;
...
var n__4607__auto___22558 = a.length;
var i_22561 = (0);
while(true){
if((i_22561 < n__4607__auto___22558)){
(a[i_22561] = reagent.impl.template.as_element((a[i_22561])));

var G__22562 = (i_22561 + (1));
i_22561 = G__22562;
continue;
} else {
}
...
var i_22566 = (0);
while(true){
if((i_22566 < n__4607__auto___22564)){
var val_22567 = (a[i_22566]);
if(((cljs.core.vector_QMARK_(val_22567)) && ((reagent.impl.template.key_from_vec(val_22567) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_22566] = reagent.impl.template.as_element(val_22567));

var G__22570 = (i_22566 + (1));
i_22566 = G__22570;
continue;
} else {
}
...
var ctx = ({});
var vec__22467 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22467,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22467,(1),null);
...
var G__22470 = (cljs.core.count(argv) - first_child);
switch (G__22470) {
case (0):
...
case (1):
var G__22471 = comp;
var G__22472 = jsprops;
var G__22473 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__22471,G__22472,G__22473);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__22470){
