...
day8.re_frame_10x.view.components.search_input = (function day8$re_frame_10x$view$components$search_input(p__21996){
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21997__$1,new cljs.core.Keyword(null,"title","title",636505583));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21997__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var on_save = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21997__$1,new cljs.core.Keyword(null,"on-save","on-save",1618176266));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21997__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var on_stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21997__$1,new cljs.core.Keyword(null,"on-stop","on-stop",1520114515));
var val = mranderson048.reagent.v0v8v0.reagent.core.atom.cljs$core$IFn$_invoke$arity$1(title);
var save = ((function (val,map__21997,map__21997__$1,title,placeholder,on_save,on_change,on_stop){
return (function (){
...
});})(val,map__21997,map__21997__$1,title,placeholder,on_save,on_change,on_stop))
;
return ((function (val,save,map__21997,map__21997__$1,title,placeholder,on_save,on_change,on_stop){
return (function (){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(val),new cljs.core.Keyword(null,"auto-focus","auto-focus",1250006231),true,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),placeholder,new cljs.core.Keyword(null,"size","size",1098693007),((((20) > cljs.core.count(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(val)))))?(25):cljs.core.count(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(val)))),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (val,save,map__21997,map__21997__$1,title,placeholder,on_save,on_change,on_stop){
return (function (p1__21994_SHARP_){
cljs.core.reset_BANG_(val,p1__21994_SHARP_.target.value);

return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(p1__21994_SHARP_) : on_change.call(null,p1__21994_SHARP_));
});})(val,save,map__21997,map__21997__$1,title,placeholder,on_save,on_change,on_stop))
,new cljs.core.Keyword(null,"on-key-down","on-key-down",-1374733765),((function (val,save,map__21997,map__21997__$1,title,placeholder,on_save,on_change,on_stop){
return (function (p1__21995_SHARP_){
var G__22001 = p1__21995_SHARP_.which;
switch (G__22001) {
case (13):
save();
...
day8.re_frame_10x.view.components.autoscroll_list = (function day8$re_frame_10x$view$components$autoscroll_list(p__22004,child){
var map__22005 = p__22004;
var map__22005__$1 = (((((!((map__22005 == null))))?(((((map__22005.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22005.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22005):map__22005);
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22005__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var scroll_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22005__$1,new cljs.core.Keyword(null,"scroll?","scroll?",-1393045951));
...
return mranderson048.reagent.v0v8v0.reagent.core.create_class(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"display-name","display-name",694513143),"autoscroll-list",new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),((function (node,should_scroll,map__22005,map__22005__$1,class$,scroll_QMARK_){
return (function (_){
...
});})(node,should_scroll,map__22005,map__22005__$1,class$,scroll_QMARK_))
,new cljs.core.Keyword(null,"component-will-update","component-will-update",335247566),((function (node,should_scroll,map__22005,map__22005__$1,class$,scroll_QMARK_){
return (function (_){
...
,new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),((function (node,should_scroll,map__22005,map__22005__$1,class$,scroll_QMARK_){
return (function (_){
...
,new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),((function (node,should_scroll,map__22005,map__22005__$1,class$,scroll_QMARK_){
return (function (p__22011,child__$1){
var map__22012 = p__22011;
var map__22012__$1 = (((((!((map__22012 == null))))?(((((map__22012.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22012.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22012):map__22012);
var class$__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22012__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),class$__$1,new cljs.core.Keyword(null,"ref","ref",1289896967),((function (map__22012,map__22012__$1,class$__$1,node,should_scroll,map__22005,map__22005__$1,class$,scroll_QMARK_){
return (function (dom_node){
return cljs.core.reset_BANG_(node,dom_node);
});})(map__22012,map__22012__$1,class$__$1,node,should_scroll,map__22005,map__22005__$1,class$,scroll_QMARK_))
], null),child__$1], null);
});})(node,should_scroll,map__22005,map__22005__$1,class$,scroll_QMARK_))
], null));
});
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__22021){
var vec__22022 = p__22021;
var property = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22022,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22022,(1),null);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(property),value);
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22020_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__22020_SHARP_,/:/);
...
var previous_config__21982__auto__ = devtools.prefs.get_prefs();
var prefs__21983__auto__ = day8.re_frame_10x.view.components.effective_cljs_devtools_prefs;
try{devtools.prefs.set_prefs_BANG_(prefs__21983__auto__);

return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(api_fn,args);
}finally {if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.prefs.get_prefs(),prefs__21983__auto__)){
} else {
throw (new Error(["Assert failed: ","someone modified devtools.prefs behind our back!","\n","(clojure.core/= (devtools.prefs/get-prefs) prefs__21983__auto__)"].join('')));
}

devtools.prefs.set_prefs_BANG_(previous_config__21982__auto__);
}});

day8.re_frame_10x.view.components.make_devtools_api_call.cljs$lang$maxFixedArity = (1);

/** @this {Function} */
day8.re_frame_10x.view.components.make_devtools_api_call.cljs$lang$applyTo = (function (seq22025){
...
/** @this {Function} */
day8.re_frame_10x.view.components.cljs_devtools_header.cljs$lang$applyTo = (function (seq22030){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq22030));
});
...
/** @this {Function} */
day8.re_frame_10x.view.components.cljs_devtools_body.cljs$lang$applyTo = (function (seq22033){
var self__4718__auto__ = this;
...
/** @this {Function} */
day8.re_frame_10x.view.components.cljs_devtools_has_body.cljs$lang$applyTo = (function (seq22035){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq22035));
});
...
var expanded_QMARK_ = (function (){var G__22039 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","node-expanded?","app-db/node-expanded?",-1032853540),path], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__22039) : mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.call(null,G__22039));
})();
...
return (function (){
var G__22042 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","toggle-expansion","app-db/toggle-expansion",-1617765538),path__$1], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__22042) : mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.call(null,G__22042));
});})(expanded_QMARK_))
...
var G__22093 = (i__4731__auto___22088 + (1));
i__4731__auto___22088 = G__22093;
continue;
} else {
}
break;
