...
day8.re_frame_10x.view.settings.settings_box_81 = mranderson048.garden.v1v3v3.garden.compiler.render_css((function (){var G__21946 = day8.re_frame_10x.common_styles.gs_81;
var G__21947 = (mranderson048.garden.v1v3v3.garden.units.px_STAR_.cljs$core$IFn$_invoke$arity$2 ? mranderson048.garden.v1v3v3.garden.units.px_STAR_.cljs$core$IFn$_invoke$arity$2((2),day8.re_frame_10x.view.settings.settings_box_vertical_padding) : mranderson048.garden.v1v3v3.garden.units.px_STAR_.call(null,(2),day8.re_frame_10x.view.settings.settings_box_vertical_padding));
return (mranderson048.garden.v1v3v3.garden.units.px_.cljs$core$IFn$_invoke$arity$2 ? mranderson048.garden.v1v3v3.garden.units.px_.cljs$core$IFn$_invoke$arity$2(G__21946,G__21947) : mranderson048.garden.v1v3v3.garden.units.px_.call(null,G__21946,G__21947));
})());
...
while(true){
if((i__4731__auto___22032 < len__4730__auto___22030)){
...
var num_traces = cljs.core.deref((function (){var G__21971 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("traces","number-of-traces","traces/number-of-traces",-1195045241)], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__21971) : mranderson048.re_frame.v0v10v6.re_frame.core.subscribe.call(null,G__21971));
})());
...
return (function (){
var G__21977 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","reset","epochs/reset",1592438868)], null);
...
})(),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.line], null),(function (){var follows_events_QMARK_ = cljs.core.deref((function (){var G__21979 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","app-db-follows-events?","settings/app-db-follows-events?",-115495889)], null);
...
var G__21980 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","app-db-follows-events?","settings/app-db-follows-events?",-115495889),p1__21959_SHARP_], null);
return (mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__21980) : mranderson048.re_frame.v0v10v6.re_frame.core.dispatch.call(null,G__21980));
...
var G__21982 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","add-ignored-event","settings/add-ignored-event",-1185281607)], null);
...
})], null)], null)], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"width","width",-384071477),day8.re_frame_10x.view.settings.comp_section_width,new cljs.core.Keyword(null,"gap","gap",80255254),day8.re_frame_10x.view.settings.vertical_gap,new cljs.core.Keyword(null,"children","children",-940561982),(function (){var iter__4523__auto__ = (function day8$re_frame_10x$view$settings$render_$_iter__21989(s__21990){
return (new cljs.core.LazySeq(null,(function (){
var s__21990__$1 = s__21990;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__21990__$1);
if(temp__5457__auto__){
var s__21990__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__21990__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__21990__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__21993 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__21992 = (0);
while(true){
if((i__21992 < size__4522__auto__)){
var item = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__21992);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
cljs.core.chunk_append(b__21993,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"event-str","event-str",381347778).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"212px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (i__21992,id,item,c__4521__auto__,size__4522__auto__,b__21993,s__21990__$2,temp__5457__auto__){
return (function (){
...
});})(i__21992,id,item,c__4521__auto__,size__4522__auto__,b__21993,s__21990__$2,temp__5457__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__21992,id,item,c__4521__auto__,size__4522__auto__,b__21993,s__21990__$2,temp__5457__auto__){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21993),day8$re_frame_10x$view$settings$render_$_iter__21989(cljs.core.chunk_rest(s__21990__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21993),null);
}
} else {
var item = cljs.core.first(s__21990__$2);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"event-str","event-str",381347778).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"212px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (id,item,s__21990__$2,temp__5457__auto__){
return (function (){
var G__22005 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","remove-ignored-event","settings/remove-ignored-event",-391073521),id], null);
...
});})(id,item,s__21990__$2,temp__5457__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (id,item,s__21990__$2,temp__5457__auto__){
return (function (p1__21960_SHARP_){
...
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$settings$render_$_iter__21989(cljs.core.rest(s__21990__$2)));
}
} else {
return null;
}
...
var G__22023 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","low-level-trace","settings/low-level-trace",191054289),new cljs.core.Keyword(null,"reagent","reagent",2131627322),p1__21964_SHARP_], null);
...
var G__22024 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","low-level-trace","settings/low-level-trace",191054289),new cljs.core.Keyword(null,"re-frame","re-frame",-1039473033),p1__21965_SHARP_], null);
...
var G__22026 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","factory-reset","settings/factory-reset",1863855805)], null);
