...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq22448){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__22461_SHARP_){
return (!((cljs.core.meta(p1__22461_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22486__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e22490){var _e__21932__auto__ = e22490;
return false;
}})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
}catch (e22494){var _e__21932__auto__ = e22494;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__22500 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__22501 = devtools.formatters.state.get_current_state();
devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__22501;

try{var map__22503 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22503__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__22500;
}});
...
;
var temp__5455__auto___22531 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5455__auto___22531)){
var managed_print_level_22532 = temp__5455__auto___22531;
var _STAR_print_level_STAR__orig_val__22509_22533 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__22510_22534 = managed_print_level_22532;
cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__22510_22534;

try{devtools.formatters.state.update_current_state_BANG_(((function (_STAR_print_level_STAR__orig_val__22509_22533,_STAR_print_level_STAR__temp_val__22510_22534,managed_print_level_22532,temp__5455__auto___22531,writer,opts,job_fn){
return (function (p1__22508_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__22508_SHARP_,null);
});})(_STAR_print_level_STAR__orig_val__22509_22533,_STAR_print_level_STAR__temp_val__22510_22534,managed_print_level_22532,temp__5455__auto___22531,writer,opts,job_fn))
);

job_fn();
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__22509_22533;
}} else {
job_fn();
}
