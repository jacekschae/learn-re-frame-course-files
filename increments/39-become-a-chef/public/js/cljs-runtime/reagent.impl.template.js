...
var G__22406 = o;
(G__22406[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__22481__delegate = function (args){
...
while (G__22482__i < G__22482__a.length) {G__22482__a[G__22482__i] = arguments[G__22482__i + 0]; ++G__22482__i;}
  args = new cljs.core.IndexedSeq(G__22482__a,0,null);
} 
...
var G__22412 = o;
(G__22412[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__22488__i < G__22488__a.length) {G__22488__a[G__22488__i] = arguments[G__22488__i + 0]; ++G__22488__i;}
  args = new cljs.core.IndexedSeq(G__22488__a,0,null);
} 
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22421__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__22425){
...
var props = map__22426__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22426__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__22426,map__22426__$1,props,class$){
return (function (c){
...
});})(map__22426,map__22426__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__22431){
var map__22432 = p__22431;
var map__22432__$1 = (((((!((map__22432 == null))))?(((((map__22432.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22432.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22432):map__22432);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22432__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__22432,map__22432__$1,on_write){
return (function (){
...
});})(node_value,map__22432,map__22432__$1,on_write))
);
} else {
...
return reagent.impl.template.input_handle_change(this$,on_change,p1__22443_SHARP_);
...
var jsprops = ({"argv": v});
var temp__5461__auto___22526 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___22526 == null)){
} else {
var key_22527 = temp__5461__auto___22526;
(jsprops["key"] = key_22527);
}
...
var temp__5461__auto___22528 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___22528 == null)){
} else {
var key_22529 = temp__5461__auto___22528;
reagent.impl.template.oset(jsprops,"key",key_22529);
}
...
var G__22535 = (i__4731__auto___22534 + (1));
i__4731__auto___22534 = G__22535;
continue;
} else {
}
break;
...
break;
default:
var G__22560 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__22560;
continue;
...
var n__4607__auto___22565 = a.length;
var i_22566 = (0);
while(true){
if((i_22566 < n__4607__auto___22565)){
(a[i_22566] = reagent.impl.template.as_element((a[i_22566])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___22572 = a.length;
var i_22573 = (0);
while(true){
if((i_22573 < n__4607__auto___22572)){
var val_22574 = (a[i_22573]);
if(((cljs.core.vector_QMARK_(val_22574)) && ((reagent.impl.template.key_from_vec(val_22574) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_22573] = reagent.impl.template.as_element(val_22574));

var G__22575 = (i_22573 + (1));
i_22573 = G__22575;
continue;
} else {
}
...
var G__22469 = (cljs.core.count(argv) - first_child);
switch (G__22469) {
case (0):
...
break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__22469){
