...
app.auth.events.set_user_ls_BANG_ = (function app$auth$events$set_user_ls_BANG_(p__25856){
var map__25859 = p__25856;
var map__25859__$1 = (((((!((map__25859 == null))))?(((((map__25859.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25859.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__25859):map__25859);
var auth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25859__$1,new cljs.core.Keyword(null,"auth","auth",1389754926));
...
var G__25863_25924 = new cljs.core.Keyword(null,"local-store-user","local-store-user",1737970699);
var G__25864_25925 = ((function (G__25863_25924){
...
;
(re_frame.core.reg_cofx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_cofx.cljs$core$IFn$_invoke$arity$2(G__25863_25924,G__25864_25925) : re_frame.core.reg_cofx.call(null,G__25863_25924,G__25864_25925));
...
var vec__25873 = p__25870;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25873,(0),null);
var map__25876 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25873,(1),null);
...
var first_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25876__$1,new cljs.core.Keyword(null,"first-name","first-name",-1559982131));
var last_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25876__$1,new cljs.core.Keyword(null,"last-name","last-name",-1695738974));
var email = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25876__$1,new cljs.core.Keyword(null,"email","email",1415816706));
var password = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25876__$1,new cljs.core.Keyword(null,"password","password",417022471));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"log-in","log-in",526627385),app.auth.events.set_user_interceptors,(function (p__25891,p__25892){
var map__25894 = p__25891;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25894__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__25895 = p__25892;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25895,(0),null);
var map__25898 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25895,(1),null);
var map__25898__$1 = (((((!((map__25898 == null))))?(((((map__25898.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25898.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__25898):map__25898);
var email = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25898__$1,new cljs.core.Keyword(null,"email","email",1415816706));
var password = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25898__$1,new cljs.core.Keyword(null,"password","password",417022471));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"log-out","log-out",-2094664701),app.auth.events.remove_user_interceptors,(function (p__25902,_){
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"delete-account","delete-account",725157341),app.auth.events.remove_user_interceptors,(function (p__25913,_){
var map__25914 = p__25913;
var map__25914__$1 = (((((!((map__25914 == null))))?(((((map__25914.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25914.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__25914):map__25914);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25914__$1,new cljs.core.Keyword(null,"db","db",993250759));
var uid = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"auth","auth",1389754926),new cljs.core.Keyword(null,"uid","uid",-1447769400)], null));
