...
var G__22034 = cljs.core.PersistentArrayMap.EMPTY;
var G__22035 = native_stack_trace;
var G__22036 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__22037 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__22034,G__22035,G__22036,G__22037) : cljs.stacktrace.parse_stacktrace.call(null,G__22034,G__22035,G__22036,G__22037));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22039__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22039__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22039__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e22038){var _e = e22038;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___22088 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5455__auto___22088)){
var seen_errors_22089 = temp__5455__auto___22088;
if(cljs.core.truth_(seen_errors_22089.has(self))){
} else {
seen_errors_22089.add(self);

var temp__5457__auto___22091 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5457__auto___22091)){
var sense_22092 = temp__5457__auto___22091;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_22092)].join('');
} else {
}
}
} else {
