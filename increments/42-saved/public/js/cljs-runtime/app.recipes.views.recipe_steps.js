...
var step = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26155__$1,new cljs.core.Keyword(null,"step","step",1288888124));
var G__26159_26207 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"open-modal","open-modal",947793572),modal_name], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__26159_26207) : re_frame.core.dispatch.call(null,G__26159_26207));
...
var map__26161__$1 = (((((!((map__26161 == null))))?(((((map__26161.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__26161.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__26161):map__26161);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26161__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var desc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26161__$1,new cljs.core.Keyword(null,"desc","desc",2093485764));
var G__26165_26243 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"upsert-step","upsert-step",-776873689),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4131__auto__ = id;
...
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__26165_26243) : re_frame.core.dispatch.call(null,G__26165_26243));
...
return (function (){
var steps = cljs.core.deref((function (){var G__26168 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"steps","steps",-128433302)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__26168) : re_frame.core.subscribe.call(null,G__26168));
})());
var author_QMARK_ = cljs.core.deref((function (){var G__26169 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"author?","author?",-1083349935)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__26169) : re_frame.core.subscribe.call(null,G__26169));
})());
...
return (function app$recipes$views$recipe_steps$recipe_steps_$_iter__26172(s__26173){
...
while(true){
var temp__5457__auto__ = cljs.core.seq(s__26173__$1);
if(temp__5457__auto__){
var s__26173__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26173__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__26173__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__26175 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__26174 = (0);
while(true){
if((i__26174 < size__4522__auto__)){
var map__26178 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__26174);
var map__26178__$1 = (((((!((map__26178 == null))))?(((((map__26178.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__26178.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__26178):map__26178);
var step = map__26178__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26178__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var desc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26178__$1,new cljs.core.Keyword(null,"desc","desc",2093485764));
cljs.core.chunk_append(b__26175,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Box,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"py","py",1397985916),(10)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Row,(cljs.core.truth_(author_QMARK_)?new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__26174,map__26178,map__26178__$1,step,id,desc,c__4521__auto__,size__4522__auto__,b__26175,s__26173__$2,temp__5457__auto__,steps,author_QMARK_,initial_values,values,open_modal,save){
return (function (){
...
});})(i__26174,map__26178,map__26178__$1,step,id,desc,c__4521__auto__,size__4522__auto__,b__26175,s__26173__$2,temp__5457__auto__,steps,author_QMARK_,initial_values,values,open_modal,save))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26175),app$recipes$views$recipe_steps$recipe_steps_$_iter__26172(cljs.core.chunk_rest(s__26173__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26175),null);
}
} else {
var map__26184 = cljs.core.first(s__26173__$2);
...
var step = map__26184__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26184__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var desc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26184__$1,new cljs.core.Keyword(null,"desc","desc",2093485764));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Box,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"py","py",1397985916),(10)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Row,(cljs.core.truth_(author_QMARK_)?new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__26184,map__26184__$1,step,id,desc,s__26173__$2,temp__5457__auto__,steps,author_QMARK_,initial_values,values,open_modal,save){
return (function (){
return open_modal(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"modal-name","modal-name",-2096322394),new cljs.core.Keyword(null,"step-editor","step-editor",1799616437),new cljs.core.Keyword(null,"step","step",1288888124),step], null));
});})(map__26184,map__26184__$1,step,id,desc,s__26173__$2,temp__5457__auto__,steps,author_QMARK_,initial_values,values,open_modal,save))
,new cljs.core.Keyword(null,"class","class",-2030961996),"editable"], null):null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Col,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"py","py",1397985916),(10)], null),desc], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),app$recipes$views$recipe_steps$recipe_steps_$_iter__26172(cljs.core.rest(s__26173__$2)));
}
} else {
return null;
}
...
var G__26191 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"delete-step","delete-step",587926903),step_id], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__26191) : re_frame.core.dispatch.call(null,G__26191));
} else {
return null;
}
...
return (function (){
var G__26192 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"close-modal","close-modal",-1882189985)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__26192) : re_frame.core.dispatch.call(null,G__26192));
});})(steps,author_QMARK_,initial_values,values,open_modal,save))
