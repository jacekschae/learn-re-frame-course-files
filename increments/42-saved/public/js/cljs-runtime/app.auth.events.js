...
app.auth.events.set_user_ls_BANG_ = (function app$auth$events$set_user_ls_BANG_(p__25920){
...
var auth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25921__$1,new cljs.core.Keyword(null,"auth","auth",1389754926));
...
var G__25923_25953 = new cljs.core.Keyword(null,"local-store-user","local-store-user",1737970699);
var G__25924_25954 = ((function (G__25923_25953){
...
;
(re_frame.core.reg_cofx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_cofx.cljs$core$IFn$_invoke$arity$2(G__25923_25953,G__25924_25954) : re_frame.core.reg_cofx.call(null,G__25923_25953,G__25924_25954));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"sign-up","sign-up",-1190725688),app.auth.events.set_user_interceptors,(function (p__25925,p__25926){
var map__25927 = p__25925;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25927__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__25928 = p__25926;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25928,(0),null);
var map__25931 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25928,(1),null);
...
var first_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25931__$1,new cljs.core.Keyword(null,"first-name","first-name",-1559982131));
var last_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25931__$1,new cljs.core.Keyword(null,"last-name","last-name",-1695738974));
var email = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25931__$1,new cljs.core.Keyword(null,"email","email",1415816706));
var password = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25931__$1,new cljs.core.Keyword(null,"password","password",417022471));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"log-in","log-in",526627385),app.auth.events.set_user_interceptors,(function (p__25934,p__25935){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25936__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__25937 = p__25935;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25937,(0),null);
var map__25940 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25937,(1),null);
...
var email = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25940__$1,new cljs.core.Keyword(null,"email","email",1415816706));
var password = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25940__$1,new cljs.core.Keyword(null,"password","password",417022471));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"log-out","log-out",-2094664701),app.auth.events.remove_user_interceptors,(function (p__25943,_){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25944__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"update-profile","update-profile",1458083625),(function (db,p__25946){
var vec__25947 = p__25946;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25947,(0),null);
var profile = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25947,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"delete-account","delete-account",725157341),app.auth.events.remove_user_interceptors,(function (p__25950,_){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25951__$1,new cljs.core.Keyword(null,"db","db",993250759));
var uid = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"auth","auth",1389754926),new cljs.core.Keyword(null,"uid","uid",-1447769400)], null));
