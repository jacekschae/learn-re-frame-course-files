...
var G__22401 = o;
(G__22401[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__22405 = props;
var G__22405__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22405,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22405);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22405__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__22406){
var map__22407 = p__22406;
var map__22407__$1 = (((((!((map__22407 == null))))?(((((map__22407.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22407.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22407):map__22407);
var props = map__22407__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22407__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__22407,map__22407__$1,props,class$){
return (function (c){
...
});})(map__22407,map__22407__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__22409){
...
return reagent.impl.batching.do_after_render(((function (node_value,map__22410,map__22410__$1,on_write){
return (function (){
...
});})(node_value,map__22410,map__22410__$1,on_write))
);
} else {
...
var G__22414 = jsprops;
(G__22414["defaultValue"] = value);

(G__22414["onChange"] = ((function (G__22414,v,value,on_change){
return (function (p1__22412_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__22412_SHARP_);
});})(G__22414,v,value,on_change))
);
...
var vec__22416 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22416,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22416,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22416,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___22521 = reagent.impl.template.key_from_vec(v);
...
var temp__5461__auto___22524 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___22524 == null)){
} else {
var key_22525 = temp__5461__auto___22524;
reagent.impl.template.oset(jsprops,"key",key_22525);
}
...
var G__22428 = reagent.impl.template.__GT_NativeWrapper();
(G__22428["name"] = c);
...
var G__22432 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__22432) : reagent.impl.template.as_element.call(null,G__22432));
} else {
...
var len__4730__auto___22534 = arguments.length;
var i__4731__auto___22535 = (0);
while(true){
if((i__4731__auto___22535 < len__4730__auto___22534)){
args__4736__auto__.push((arguments[i__4731__auto___22535]));

var G__22536 = (i__4731__auto___22535 + (1));
i__4731__auto___22535 = G__22536;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq22438){
var G__22439 = cljs.core.first(seq22438);
var seq22438__$1 = cljs.core.next(seq22438);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22439,seq22438__$1);
});
...
break;
default:
var G__22555 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__22555;
continue;
...
var n__4607__auto___22562 = a.length;
var i_22563 = (0);
while(true){
if((i_22563 < n__4607__auto___22562)){
(a[i_22563] = reagent.impl.template.as_element((a[i_22563])));

var G__22565 = (i_22563 + (1));
i_22563 = G__22565;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___22566 = a.length;
var i_22567 = (0);
while(true){
if((i_22567 < n__4607__auto___22566)){
var val_22568 = (a[i_22567]);
if(((cljs.core.vector_QMARK_(val_22568)) && ((reagent.impl.template.key_from_vec(val_22568) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_22567] = reagent.impl.template.as_element(val_22568));

var G__22569 = (i_22567 + (1));
i_22567 = G__22569;
continue;
} else {
}
...
var ctx = ({});
var vec__22449 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22449,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22449,(1),null);
...
var G__22461 = (cljs.core.count(argv) - first_child);
switch (G__22461) {
case (0):
...
case (1):
var G__22462 = comp;
var G__22463 = jsprops;
var G__22464 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__22462,G__22463,G__22464);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__22461){
