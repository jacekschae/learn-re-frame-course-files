...
var G__22446 = devtools.prefs.pref(v);
v = G__22446;
continue;
} else {
return v;
...
}catch (e22414){var _e__21932__auto__ = e22414;
return false;
}})();
...
}catch (e22418){var _e__21932__auto__ = e22418;
return false;
}})();
...
}catch (e22420){var _e__21932__auto__ = e22420;
return false;
}}
}
});
...
var vec__22429 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22429,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22429,(1),null);
...
return cljs.core.some((function (p1__22436_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__22436_SHARP_);
}),template);
});
