...
var G__26065 = (i__26011 + (1));
i__26011 = G__26065;
continue;
} else {
var G__26066 = (i__26011 + (1));
i__26011 = G__26066;
continue;
}
} else {
...
var map__26021 = cljs.core.first(s__26010__$2);
...
var hidden_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26021__$1,new cljs.core.Keyword(null,"hidden?","hidden?",1339691380));
if(cljs.core.not(hidden_QMARK_)){
...
var G__26073 = cljs.core.rest(s__26010__$2);
s__26010__$1 = G__26073;
continue;
}
}
} else {
