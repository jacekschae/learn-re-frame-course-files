...
var o22138 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22138["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22139 = temp__5455__auto____$1;
return (o22139["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21912__auto__ = f;
return (o__21912__auto__["toString"]).call(o__21912__auto__);
} else {
return "";
}
}catch (e22144){var _ = e22144;
return "";
}});
...
try{var o__21912__auto___22403 = t;
(o__21912__auto___22403["cljs$lang$ctorPrWriter"]).call(o__21912__auto___22403,t,writer);
}catch (e22159){var __22404 = e22159;
}
...
var char_code = (function (){var o__21912__auto__ = (new String(char$));
return (o__21912__auto__["charCodeAt"]).call(o__21912__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21912__auto__ = String;
return (o__21912__auto__["fromCharCode"]).call(o__21912__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22177 = num_code;
switch (G__22177) {
case (1):
return (185);
...
var o__21912__auto__ = String;
return (o__21912__auto__["fromCharCode"]).call(o__21912__auto__,superscript_code);
});
/**
...
}catch (e22203){var _e__21932__auto__ = e22203;
return false;
}})())){
...
var vec__22205 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22205,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o22232 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22232["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22233 = temp__5455__auto____$1;
return (o22233["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___22422 = arguments.length;
var i__4731__auto___22423 = (0);
while(true){
if((i__4731__auto___22423 < len__4730__auto___22422)){
args__4736__auto__.push((arguments[i__4731__auto___22423]));

var G__22424 = (i__4731__auto___22423 + (1));
i__4731__auto___22423 = G__22424;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22239){
var vec__22240 = p__22239;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22240,(0),null);
...
var G__22426 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__22427 = cljs.core.butlast(remaining_tokens);
name_tokens = G__22426;
remaining_tokens = G__22427;
continue;
}
}
break;
...
var vec__22249 = cljs.core.split_with((function (p1__22248_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__22248_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22249,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22249,(1),null);
...
var vec__22255 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22255,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22255,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__22432 = cljs.core.rest(remaining_tokens);
var G__22433 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__22432;
name_tokens = G__22433;
continue;
} else {
...
var vec__22263 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22263,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22263,(1),null);
var vec__22266 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22266,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22266,(1),null);
var vec__22269 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22269,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22269,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22269,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22269,(3),null);
...
var vec__22275 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22275,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22275,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22275,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22275,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22275,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22275,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__22279 = temp__5455__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22279,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22279,(1),null);
var vec__22284 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22284,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22284,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__22289 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__22289) : devtools.munging.parse_fn_info_deep.call(null,G__22289));
})()));
}
} else {
return fn_info;
...
var G__22451 = (arity + (1));
var G__22452 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22303){
var vec__22304 = p__22303;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22304,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22304,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__22315_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__22316_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22319){
var vec__22320 = p__22319;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22320,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22317){
var G__22318 = cljs.core.first(seq22317);
var seq22317__$1 = cljs.core.next(seq22317);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22318,seq22317__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22341__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22341__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22341__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22341__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22342 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22342,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22342,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22342,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22342,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22342,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22342,(5),null);
...
var o__21912__auto__ = f;
return (o__21912__auto__["getBasis"]).call(o__21912__auto__);
});
/**
...
}catch (e22355){var _e__21932__auto__ = e22355;
...
var G__22492 = (obj[cljs.core.first(path)]);
var G__22493 = cljs.core.rest(path);
obj = G__22492;
path = G__22493;
continue;
} else {
...
return (function (accum,p__22370){
var vec__22371 = p__22370;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22371,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22371,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22378){
var vec__22383 = p__22378;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22383,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22383,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22383,(2),null);
...
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22399,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22399,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__22399,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__22390_SHARP_){
return (obj[cljs.core.first(p1__22390_SHARP_)]);
});})(name,sorted_matches,vec__22399,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
