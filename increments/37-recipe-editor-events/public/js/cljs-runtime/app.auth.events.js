...
app.auth.events.set_user_ls_BANG_ = (function app$auth$events$set_user_ls_BANG_(p__25898){
var map__25899 = p__25898;
...
var auth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25899__$1,new cljs.core.Keyword(null,"auth","auth",1389754926));
...
var G__25912_25962 = new cljs.core.Keyword(null,"local-store-user","local-store-user",1737970699);
var G__25913_25963 = ((function (G__25912_25962){
...
;
(re_frame.core.reg_cofx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_cofx.cljs$core$IFn$_invoke$arity$2(G__25912_25962,G__25913_25963) : re_frame.core.reg_cofx.call(null,G__25912_25962,G__25913_25963));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"sign-up","sign-up",-1190725688),app.auth.events.set_user_interceptors,(function (p__25918,p__25919){
var map__25922 = p__25918;
var map__25922__$1 = (((((!((map__25922 == null))))?(((((map__25922.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25922.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__25922):map__25922);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25922__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__25923 = p__25919;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25923,(0),null);
var map__25926 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25923,(1),null);
...
var first_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25926__$1,new cljs.core.Keyword(null,"first-name","first-name",-1559982131));
var last_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25926__$1,new cljs.core.Keyword(null,"last-name","last-name",-1695738974));
var email = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25926__$1,new cljs.core.Keyword(null,"email","email",1415816706));
var password = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25926__$1,new cljs.core.Keyword(null,"password","password",417022471));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"log-in","log-in",526627385),app.auth.events.set_user_interceptors,(function (p__25935,p__25936){
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"log-out","log-out",-2094664701),app.auth.events.remove_user_interceptors,(function (p__25948,_){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25949__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
var profile = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25954,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword(null,"delete-account","delete-account",725157341),app.auth.events.remove_user_interceptors,(function (p__25957,_){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25958__$1,new cljs.core.Keyword(null,"db","db",993250759));
var uid = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"auth","auth",1389754926),new cljs.core.Keyword(null,"uid","uid",-1447769400)], null));
