...
if((c === "\n")){
var G__30408 = escape_QMARK_;
var G__30409 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__30408;
lines = G__30409;
continue;
} else {
buf.append(c);

var G__30410 = (((!(escape_QMARK_))) && ((c === "\\")));
var G__30411 = lines;
escape_QMARK_ = G__30410;
lines = G__30411;
continue;
...
var G__30405 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__30405) : rewrite_clj.node.string_node.call(null,G__30405));
});
...
var G__30406 = cljs.core.re_pattern(regex);
var G__30407 = ["#\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(regex),"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__30406,G__30407) : rewrite_clj.node.token_node.call(null,G__30406,G__30407));
});
