...
return (function (){
var G__25975 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-active-nav","set-active-nav",-1041462259),new cljs.core.Keyword(null,"recipes","recipes",-325236209)], null);
...
], null),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"inboxes","inboxes",-619615989),new cljs.core.Keyword(null,"name","name",1843675177),"Inbox",new cljs.core.Keyword(null,"href","href",-793805698),(function (){var G__25977 = new cljs.core.Keyword(null,"inboxes","inboxes",-619615989);
...
return (function (){
var G__25979 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-active-nav","set-active-nav",-1041462259),new cljs.core.Keyword(null,"inboxes","inboxes",-619615989)], null);
...
return (function (){
var G__25983 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-active-nav","set-active-nav",-1041462259),new cljs.core.Keyword(null,"become-a-chef","become-a-chef",1113742810)], null);
...
], null),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"profile","profile",-545963874),new cljs.core.Keyword(null,"name","name",1843675177),"Profile",new cljs.core.Keyword(null,"href","href",-793805698),(function (){var G__25985 = new cljs.core.Keyword(null,"profile","profile",-545963874);
...
return (function (){
var G__25987 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-active-nav","set-active-nav",-1041462259),new cljs.core.Keyword(null,"profile","profile",-545963874)], null);
...
return (function app$nav$views$authenticated$authenticated_$_iter__25989(s__25990){
return (new cljs.core.LazySeq(null,((function (active_page,nav_items){
return (function (){
var s__25990__$1 = s__25990;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__25990__$1);
if(temp__5457__auto__){
var s__25990__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__25990__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__25990__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__25992 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__25991 = (0);
while(true){
if((i__25991 < size__4522__auto__)){
var map__25998 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__25991);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__25992),app$nav$views$authenticated$authenticated_$_iter__25989(cljs.core.chunk_rest(s__25990__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__25992),null);
}
} else {
var map__26002 = cljs.core.first(s__25990__$2);
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [app.nav.views.nav_item.nav_item,new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"key","key",-1516042587),id,new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"name","name",1843675177),name,new cljs.core.Keyword(null,"href","href",-793805698),href,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),dispatch,new cljs.core.Keyword(null,"active-page","active-page",370357330),active_page], null)], null),app$nav$views$authenticated$authenticated_$_iter__25989(cljs.core.rest(s__25990__$2)));
}
} else {
return null;
}
