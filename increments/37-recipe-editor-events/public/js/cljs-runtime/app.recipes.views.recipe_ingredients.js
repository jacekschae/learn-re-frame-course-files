...
var modal_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26092__$1,new cljs.core.Keyword(null,"modal-name","modal-name",-2096322394));
var ingredient = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26092__$1,new cljs.core.Keyword(null,"ingredient","ingredient",1011156019));
var G__26095_26124 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"open-modal","open-modal",947793572),modal_name], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__26095_26124) : re_frame.core.dispatch.call(null,G__26095_26124));
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26097__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var amount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26097__$1,new cljs.core.Keyword(null,"amount","amount",364489504));
var measure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26097__$1,new cljs.core.Keyword(null,"measure","measure",-1857519826));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26097__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var G__26102_26125 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"upsert-ingredient","upsert-ingredient",-1543603235),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4131__auto__ = id;
...
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__26102_26125) : re_frame.core.dispatch.call(null,G__26102_26125));
...
return (function (){
var ingredients = cljs.core.deref((function (){var G__26108 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ingredients","ingredients",-1855671917)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__26108) : re_frame.core.subscribe.call(null,G__26108));
})());
var author_QMARK_ = cljs.core.deref((function (){var G__26109 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"author?","author?",-1083349935)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__26109) : re_frame.core.subscribe.call(null,G__26109));
})());
...
return (function app$recipes$views$recipe_ingredients$recipe_ingredients_$_iter__26110(s__26111){
...
while(true){
var temp__5457__auto__ = cljs.core.seq(s__26111__$1);
if(temp__5457__auto__){
var s__26111__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26111__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__26111__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__26113 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__26112 = (0);
while(true){
if((i__26112 < size__4522__auto__)){
var map__26116 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__26112);
...
var ingredient = map__26116__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26116__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var amount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26116__$1,new cljs.core.Keyword(null,"amount","amount",364489504));
var measure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26116__$1,new cljs.core.Keyword(null,"measure","measure",-1857519826));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26116__$1,new cljs.core.Keyword(null,"name","name",1843675177));
cljs.core.chunk_append(b__26113,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Box,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"py","py",1397985916),(10)], null),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Row,(cljs.core.truth_(author_QMARK_)?new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__26112,map__26116,map__26116__$1,ingredient,id,amount,measure,name,c__4521__auto__,size__4522__auto__,b__26113,s__26111__$2,temp__5457__auto__,ingredients,author_QMARK_,initial_values,values,open_modal,save){
return (function (){
...
});})(i__26112,map__26116,map__26116__$1,ingredient,id,amount,measure,name,c__4521__auto__,size__4522__auto__,b__26113,s__26111__$2,temp__5457__auto__,ingredients,author_QMARK_,initial_values,values,open_modal,save))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26113),app$recipes$views$recipe_ingredients$recipe_ingredients_$_iter__26110(cljs.core.chunk_rest(s__26111__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26113),null);
}
} else {
var map__26120 = cljs.core.first(s__26111__$2);
...
var ingredient = map__26120__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26120__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var amount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26120__$1,new cljs.core.Keyword(null,"amount","amount",364489504));
var measure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26120__$1,new cljs.core.Keyword(null,"measure","measure",-1857519826));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26120__$1,new cljs.core.Keyword(null,"name","name",1843675177));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Box,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"py","py",1397985916),(10)], null),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Row,(cljs.core.truth_(author_QMARK_)?new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__26120,map__26120__$1,ingredient,id,amount,measure,name,s__26111__$2,temp__5457__auto__,ingredients,author_QMARK_,initial_values,values,open_modal,save){
return (function (){
return open_modal(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"modal-name","modal-name",-2096322394),new cljs.core.Keyword(null,"ingredient-editor","ingredient-editor",-375505998),new cljs.core.Keyword(null,"ingredient","ingredient",1011156019),ingredient], null));
});})(map__26120,map__26120__$1,ingredient,id,amount,measure,name,s__26111__$2,temp__5457__auto__,ingredients,author_QMARK_,initial_values,values,open_modal,save))
,new cljs.core.Keyword(null,"class","class",-2030961996),"editable"], null):null),new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Col,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"xs","xs",649443341),(3)], null),amount," ",measure], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Col,name], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),app$recipes$views$recipe_ingredients$recipe_ingredients_$_iter__26110(cljs.core.rest(s__26111__$2)));
}
} else {
return null;
}
...
var G__26122 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"delete-ingredient","delete-ingredient",443101563),ingredient_id], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__26122) : re_frame.core.dispatch.call(null,G__26122));
} else {
return null;
}
...
return (function (){
var G__26123 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"close-modal","close-modal",-1882189985)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__26123) : re_frame.core.dispatch.call(null,G__26123));
});})(ingredients,author_QMARK_,initial_values,values,open_modal,save))
