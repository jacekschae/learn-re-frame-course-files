...
var G__22441 = props;
var G__22441__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22441,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22441);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22441__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
return reagent.impl.template.input_handle_change(this$,on_change,p1__22450_SHARP_);
...
var jsprops = ({"argv": v});
var temp__5461__auto___22527 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___22527 == null)){
} else {
var key_22528 = temp__5461__auto___22527;
...
var temp__5461__auto___22529 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___22529 == null)){
} else {
var key_22530 = temp__5461__auto___22529;
reagent.impl.template.oset(jsprops,"key",key_22530);
}
...
break;
default:
var G__22558 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__22558;
continue;
...
var val_22564 = (a[i_22563]);
if(((cljs.core.vector_QMARK_(val_22564)) && ((reagent.impl.template.key_from_vec(val_22564) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_22563] = reagent.impl.template.as_element(val_22564));

var G__22567 = (i_22563 + (1));
i_22563 = G__22567;
continue;
} else {
}
...
var G__22481 = (cljs.core.count(argv) - first_child);
switch (G__22481) {
case (0):
...
break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__22481){
