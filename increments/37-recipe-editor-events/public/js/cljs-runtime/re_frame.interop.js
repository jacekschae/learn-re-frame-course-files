...
return [(function (){var pred__22630 = cljs.core.instance_QMARK_;
var expr__22631 = reactive_val;
if(cljs.core.truth_((pred__22630.cljs$core$IFn$_invoke$arity$2 ? pred__22630.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__22631) : pred__22630.call(null,reagent.ratom.RAtom,expr__22631)))){
return "ra";
} else {
if(cljs.core.truth_((pred__22630.cljs$core$IFn$_invoke$arity$2 ? pred__22630.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__22631) : pred__22630.call(null,reagent.ratom.RCursor,expr__22631)))){
return "rc";
} else {
if(cljs.core.truth_((pred__22630.cljs$core$IFn$_invoke$arity$2 ? pred__22630.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__22631) : pred__22630.call(null,reagent.ratom.Reaction,expr__22631)))){
return "rx";
} else {
if(cljs.core.truth_((pred__22630.cljs$core$IFn$_invoke$arity$2 ? pred__22630.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__22631) : pred__22630.call(null,reagent.ratom.Track,expr__22631)))){
return "tr";
} else {
return "other";
}
