...
var G__20795 = o;
(G__20795[mranderson048.reagent.v0v8v0.reagent.impl.template.cached_custom_prop_name(k)] = mranderson048.reagent.v0v8v0.reagent.impl.template.convert_prop_value(v));
...
var G__20798 = props;
var G__20798__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20798,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__20798);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__20798__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
var props = map__20801__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20801__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
mranderson048.reagent.v0v8v0.reagent.impl.template.input_node_set_value = (function mranderson048$reagent$v0v8v0$reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__20806){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20807__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return mranderson048.reagent.v0v8v0.reagent.impl.batching.do_after_render(((function (node_value,map__20807,map__20807__$1,on_write){
return (function (){
...
});})(node_value,map__20807,map__20807__$1,on_write))
);
} else {
...
var jsprops = ({"argv": v});
var temp__5461__auto___20847 = mranderson048.reagent.v0v8v0.reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___20847 == null)){
} else {
var key_20848 = temp__5461__auto___20847;
(jsprops["key"] = key_20848);
}
...
var temp__5461__auto___20849 = mranderson048.reagent.v0v8v0.reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___20849 == null)){
} else {
var key_20850 = temp__5461__auto___20849;
mranderson048.reagent.v0v8v0.reagent.impl.template.oset(jsprops,"key",key_20850);
}
...
break;
default:
var G__20865 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__20865;
continue;
...
var n__4607__auto___20883 = a.length;
var i_20884 = (0);
while(true){
if((i_20884 < n__4607__auto___20883)){
(a[i_20884] = mranderson048.reagent.v0v8v0.reagent.impl.template.as_element((a[i_20884])));

var G__20885 = (i_20884 + (1));
i_20884 = G__20885;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___20886 = a.length;
var i_20887 = (0);
while(true){
if((i_20887 < n__4607__auto___20886)){
var val_20888 = (a[i_20887]);
if(((cljs.core.vector_QMARK_(val_20888)) && ((mranderson048.reagent.v0v8v0.reagent.impl.template.key_from_vec(val_20888) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_20887] = mranderson048.reagent.v0v8v0.reagent.impl.template.as_element(val_20888));

var G__20891 = (i_20887 + (1));
i_20887 = G__20891;
continue;
} else {
}
