...
if((i < len)){
var k = (ks[i]);
var G__22415 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__22416 = (i + (1));
m = G__22415;
i = G__22416;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__22342 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__22342);
})());
} else {
var v = temp__5459__auto__;
...
var G__22352 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__22352) : reagent.impl.component.as_element.call(null,G__22352));
};
...
G__22428.cljs$lang$applyTo = (function (arglist__22431){
...
var _STAR_current_component_STAR__orig_val__22353 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22354 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22354;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22353;
}});
...
return ((function (G__22356,G__22356__$1){
...
var c = this;
var G__22362_22435 = (c["cljsRatom"]);
if((G__22362_22435 == null)){
} else {
reagent.ratom.dispose_BANG_(G__22362_22435);
}
...
var renders_22437 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_22438 = cljs.core.first(cljs.core.vals(renders_22437));
if((cljs.core.count(renders_22437) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_22437))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_22438)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_22438], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__22369 = name;
switch (G__22369) {
case "":
...
var G__22378 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__22378);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__22380 = fiber;
var G__22380__$1 = (((G__22380 == null))?null:(G__22380["type"]));
if((G__22380__$1 == null)){
return null;
} else {
return (G__22380__$1["displayName"]);
}
})();
var parent = (function (){var G__22381 = fiber;
if((G__22381 == null)){
return null;
} else {
return (G__22381["return"]);
}
})();
var path = (function (){var G__22382 = parent;
var G__22382__$1 = (((G__22382 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__22382) : reagent.impl.component.fiber_component_path.call(null,G__22382)));
if((G__22382__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__22382__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__4131__auto__ = (function (){var G__22388 = c;
if((G__22388 == null)){
return null;
} else {
return (G__22388["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__22389._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__22392 = c;
if((G__22392 == null)){
return null;
} else {
return (G__22392["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__22394 = c;
if((G__22394 == null)){
return null;
} else {
return G__22394._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__22398 = instance;
if((G__22398 == null)){
return null;
} else {
return (G__22398["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__22399 = instance;
if((G__22399 == null)){
return null;
} else {
return G__22399._currentElement;
}
}
})();
var name = (function (){var G__22400 = elem;
var G__22400__$1 = (((G__22400 == null))?null:(G__22400["type"]));
if((G__22400__$1 == null)){
return null;
} else {
return (G__22400__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__22402 = elem;
if((G__22402 == null)){
return null;
} else {
return (G__22402["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__22403._owner;
}
}
})();
var path = (function (){var G__22404 = owner;
var G__22404__$1 = (((G__22404 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__22404) : reagent.impl.component.component_path.call(null,G__22404)));
if((G__22404__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__22404__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
return reagent.impl.util.fun_name(G__22408__$1);
}
}
})();
