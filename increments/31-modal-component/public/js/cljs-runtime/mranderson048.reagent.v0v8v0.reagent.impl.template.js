...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__20841__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__20842__i < G__20842__a.length) {G__20842__a[G__20842__i] = arguments[G__20842__i + 0]; ++G__20842__i;}
  args = new cljs.core.IndexedSeq(G__20842__a,0,null);
} 
return G__20841__delegate.call(this,args);};
G__20841.cljs$lang$maxFixedArity = 0;
G__20841.cljs$lang$applyTo = (function (arglist__20843){
var args = cljs.core.seq(arglist__20843);
return G__20841__delegate(args);
});
...
var temp__5461__auto___20854 = mranderson048.reagent.v0v8v0.reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___20854 == null)){
} else {
var key_20855 = temp__5461__auto___20854;
...
var len__4730__auto___20878 = arguments.length;
var i__4731__auto___20879 = (0);
while(true){
if((i__4731__auto___20879 < len__4730__auto___20878)){
args__4736__auto__.push((arguments[i__4731__auto___20879]));

var G__20880 = (i__4731__auto___20879 + (1));
i__4731__auto___20879 = G__20880;
continue;
} else {
}
break;
...
break;
default:
var G__20892 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__20892;
continue;
...
var n__4607__auto___20898 = a.length;
var i_20899 = (0);
while(true){
if((i_20899 < n__4607__auto___20898)){
(a[i_20899] = mranderson048.reagent.v0v8v0.reagent.impl.template.as_element((a[i_20899])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___20901 = a.length;
var i_20902 = (0);
while(true){
if((i_20902 < n__4607__auto___20901)){
var val_20903 = (a[i_20902]);
if(((cljs.core.vector_QMARK_(val_20903)) && ((mranderson048.reagent.v0v8v0.reagent.impl.template.key_from_vec(val_20903) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_20902] = mranderson048.reagent.v0v8v0.reagent.impl.template.as_element(val_20903));

var G__20910 = (i_20902 + (1));
i_20902 = G__20910;
continue;
} else {
}
