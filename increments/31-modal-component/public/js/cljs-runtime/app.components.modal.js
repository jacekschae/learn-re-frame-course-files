...
app.components.modal.modal = (function app$components$modal$modal(p__26162){
...
var modal_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26163__$1,new cljs.core.Keyword(null,"modal-name","modal-name",-2096322394));
var header = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26163__$1,new cljs.core.Keyword(null,"header","header",119441134));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26163__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
var footer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26163__$1,new cljs.core.Keyword(null,"footer","footer",1606445390));
var active_modal = cljs.core.deref((function (){var G__26165 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"active-modal","active-modal",1608517958)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__26165) : re_frame.core.subscribe.call(null,G__26165));
})());
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$smooth_ui$core_sc$dist$smooth_ui_core_sc_cjs.Modal,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"opened","opened",-1451743091),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(active_modal,modal_name),new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (active_modal,map__26163,map__26163__$1,modal_name,header,body,footer){
return (function (){
var G__26166 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"close-modal","close-modal",-1882189985)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__26166) : re_frame.core.dispatch.call(null,G__26166));
});})(active_modal,map__26163,map__26163__$1,modal_name,header,body,footer))
