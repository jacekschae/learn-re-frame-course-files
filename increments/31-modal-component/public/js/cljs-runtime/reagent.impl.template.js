...
var G__22434 = o;
(G__22434[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__22436 = o;
(G__22436[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__22442 = props;
var G__22442__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22442,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22442);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22442__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__22443){
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__22444,map__22444__$1,props,class$){
return (function (c){
...
});})(map__22444,map__22444__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__22447){
...
var jsprops = ({"argv": v});
var temp__5461__auto___22539 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___22539 == null)){
} else {
var key_22541 = temp__5461__auto___22539;
(jsprops["key"] = key_22541);
}
...
var G__22458 = reagent.impl.template.__GT_NativeWrapper();
(G__22458["name"] = c);
...
var G__22460 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__22460) : reagent.impl.template.as_element.call(null,G__22460));
} else {
...
break;
default:
var G__22567 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__22567;
continue;
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___22577 = a.length;
var i_22578 = (0);
while(true){
if((i_22578 < n__4607__auto___22577)){
var val_22579 = (a[i_22578]);
if(((cljs.core.vector_QMARK_(val_22579)) && ((reagent.impl.template.key_from_vec(val_22579) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_22578] = reagent.impl.template.as_element(val_22579));

var G__22581 = (i_22578 + (1));
i_22578 = G__22581;
continue;
} else {
}
...
var ctx = ({});
var vec__22478 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22478,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22478,(1),null);
...
var G__22485 = (cljs.core.count(argv) - first_child);
switch (G__22485) {
case (0):
...
case (1):
var G__22487 = comp;
var G__22488 = jsprops;
var G__22489 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__22487,G__22488,G__22489);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__22485){
