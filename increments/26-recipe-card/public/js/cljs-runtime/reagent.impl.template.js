...
var G__22399 = o;
(G__22399[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__22505__delegate = function (args){
...
while (G__22506__i < G__22506__a.length) {G__22506__a[G__22506__i] = arguments[G__22506__i + 0]; ++G__22506__i;}
  args = new cljs.core.IndexedSeq(G__22506__a,0,null);
} 
return G__22505__delegate.call(this,args);};
...
return G__22505__delegate(args);
});
...
var G__22401 = o;
(G__22401[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__22509__i < G__22509__a.length) {G__22509__a[G__22509__i] = arguments[G__22509__i + 0]; ++G__22509__i;}
  args = new cljs.core.IndexedSeq(G__22509__a,0,null);
} 
...
var G__22413 = props;
var G__22413__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22413,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22413);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22413__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__22415){
var map__22416 = p__22415;
var map__22416__$1 = (((((!((map__22416 == null))))?(((((map__22416.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22416.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22416):map__22416);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__22416,map__22416__$1,props,class$){
return (function (c){
...
});})(map__22416,map__22416__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__22424){
var map__22425 = p__22424;
var map__22425__$1 = (((((!((map__22425 == null))))?(((((map__22425.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22425.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__22425):map__22425);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22425__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__22425,map__22425__$1,on_write){
return (function (){
...
});})(node_value,map__22425,map__22425__$1,on_write))
);
} else {
...
var G__22435 = jsprops;
(G__22435["defaultValue"] = value);

(G__22435["onChange"] = ((function (G__22435,v,value,on_change){
return (function (p1__22431_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__22431_SHARP_);
});})(G__22435,v,value,on_change))
);
...
var vec__22446 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22446,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22446,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22446,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___22523 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___22523 == null)){
} else {
var key_22524 = temp__5461__auto___22523;
...
var temp__5461__auto___22525 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___22525 == null)){
} else {
var key_22526 = temp__5461__auto___22525;
reagent.impl.template.oset(jsprops,"key",key_22526);
}
...
var G__22455 = reagent.impl.template.__GT_NativeWrapper();
(G__22455["name"] = c);
...
var G__22457 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__22457) : reagent.impl.template.as_element.call(null,G__22457));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq22466){
var G__22467 = cljs.core.first(seq22466);
var seq22466__$1 = cljs.core.next(seq22466);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22467,seq22466__$1);
});
...
break;
default:
var G__22536 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__22536;
continue;
...
var n__4607__auto___22538 = a.length;
var i_22539 = (0);
while(true){
if((i_22539 < n__4607__auto___22538)){
(a[i_22539] = reagent.impl.template.as_element((a[i_22539])));

var G__22540 = (i_22539 + (1));
i_22539 = G__22540;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___22541 = a.length;
var i_22542 = (0);
while(true){
if((i_22542 < n__4607__auto___22541)){
var val_22543 = (a[i_22542]);
if(((cljs.core.vector_QMARK_(val_22543)) && ((reagent.impl.template.key_from_vec(val_22543) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_22542] = reagent.impl.template.as_element(val_22543));
...
var ctx = ({});
var vec__22492 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22492,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22492,(1),null);
...
var G__22499 = (cljs.core.count(argv) - first_child);
switch (G__22499) {
case (0):
...
case (1):
var G__22501 = comp;
var G__22502 = jsprops;
var G__22503 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__22501,G__22502,G__22503);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__22499){
